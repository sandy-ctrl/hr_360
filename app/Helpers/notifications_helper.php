    ...
    function get_notification_config($event = "", $key = "", $info_options = array())
    {
        ...
        $task_link = function ($options) {
            ...
            if (isset($options->task_id)) {
                $ajax_url = get_uri("responsibility/view/");
                $id = $options->task_id;
                $url = get_uri("responsibility/view/" . $id);
            }
            ...
            if ((isset($options->task_id) && $options->task_id) || (isset($options->project_id) && $options->project_id)) {
                ...
                return array("url" => get_uri("responsibility/all_tasks"));
            }
        };
        ...
        $project_link = function ($options) {
            ...
            if (isset($options->project_id)) {
                $url = get_uri("enterprises/view/" . $options->project_id);
        ...
        $project_file_link = function ($options) {
            ...
            if (isset($options->project_id)) {
                $url = get_uri("enterprises/view/" . $options->project_id . "/files");
            }

            if (isset($options->project_file_id)) {
                $app_modal_url = get_uri("enterprises/view_file/" . $options->project_file_id);
        ...
        $client_link = function ($options) {
            ...
            if (isset($options->client_id)) {
                $url = get_uri("patrons/view/" . $options->client_id);
            }
        ...
        $leave_link = function ($options) {
            ...
            if (isset($options->leave_id)) {
                ...
                $ajax_url = get_uri("vacates/application_details");
                $id = $options->leave_id;
            }
        ...
        $ticket_link = function ($options) {
            ...
            if (isset($options->ticket_id)) {
                $url = get_uri("tokens/view/" . $options->ticket_id);
            }
        ...
        $invoice_link = function ($options) {
            ...
            if (isset($options->invoice_id)) {
                $url = get_uri("bills/preview/" . $options->invoice_id);
            }
        ...
        $estimate_link = function ($options) {
            ...
            if (isset($options->estimate_id)) {
                $url = get_uri("evaluations/preview/" . $options->estimate_id);
            }
        ...
        $order_link = function ($options) {
            ...
            if (isset($options->order_id)) {
                $url = get_uri("outlet/order_preview/" . $options->order_id . "/1");
            }
        ...
        $estimate_request_link = function ($options) {
            ...
            if (isset($options->estimate_request_id)) {
                $url = get_uri("evaluation_requests/view_estimate_request/" . $options->estimate_request_id);
            }
        ...
        $message_link = function ($options) {
            ...
            if (isset($options->actual_message_id)) {
                ...
                $url = get_uri("memos/inbox/" . $message_id);
            }
        ...
        $announcement_link = function ($options) {
            ...
            if (isset($options->announcement_id)) {
                $url = get_uri("notices/view/" . $options->announcement_id);
            }
        ...
        $event_link = function ($options) {
            ...
            if (isset($options->event_id)) {
                ...
                $url = get_uri("schedules/index/" . $id);
            }

            if (isset($options->task_id)) {
                $ajax_url = get_uri("schedules/view");
            }
        ...
        $lead_link = function ($options) {
            ...
            if (isset($options->lead_id)) {
                $url = get_uri("initiates/view/" . $options->lead_id);
            }
        ...
        $contract_link = function ($options) {
            ...
            if (isset($options->contract_id)) {
                $url = get_uri("agreements/preview/" . $options->contract_id . "/1");
        ...
        $proposal_link = function ($options) {
            ...
            if (isset($options->proposal_id)) {
                $url = get_uri("plans/preview/" . $options->proposal_id . "/1");
        ...
        $timeline_link = function ($options) {
            ...
            if (isset($options->post_id)) {
                $url = get_uri("agenda/post/" . $options->post_id);
            }
            return array("url" => $url);
        };
        ...
        $subscription_link = function ($options) {
            ...
            if (isset($options->subscription_id)) {
                $url = get_uri("membership/preview/" . $options->subscription_id);
            }
...
if (!function_exists('send_notification_emails')) {
    ...
    function send_notification_emails($notification_id, $email_notify_to = array(), $extra_data = array())
    {
        ...
        if ($notification->category == "ticket" && $notification->event !== "ticket_assigned") {
            ...
            $comment_info = $ci->Token_comments_model->get_details($comments_options)->getRow();
            ...
            $message_info = $ci->Memos_model->get_details(array("id" => $notification->actual_message_id))->row;
            ...
            if ($notification->event == "message_reply_sent") {
                $main_message_info = $ci->Memos_model->get_details(array("id" => $message_info->message_id))->row;
            ...
            $primary_contact = $ci->Patrons_model->get_primary_contact($invoice_info->client_id, true);
            ...
            if (array_search("client_all_contacts", $notify_to_terms) !== false || array_search("client_primary_contact", $notify_to_terms) !== false) {
                ...
                $ci->Bills_model->ci_save($invoice_status_data, $notification->invoice_id);
            }
            ...
            if ($notification->event == "estimate_commented") {
                ...
                $estimate_request_info = $ci->Evaluation_requests_model->get_one($notification->estimate_request_id);
                $primary_contact = $ci->Patrons_model->get_primary_contact($estimate_request_info->client_id, true);
            ...
            $order_info = $ci->Arrangements_model->get_one($notification->order_id);
            $primary_contact = $ci->Patrons_model->get_primary_contact($order_info->client_id, true);
            ...
            $subscription_info = $ci->Membership_model->get_one($notification->subscription_id);
            $primary_contact = $ci->Patrons_model->get_primary_contact($subscription_info->client_id, true);
            ...
            $task_info = $ci->Responsibility_model->get_details(array("id" => $notification->task_id))->getRow();
        ...
        if ($notification_multiple_tasks_user_wise && ($notification->event == "project_task_deadline_pre_reminder" || $notification->event == "project_task_reminder_on_the_day_of_deadline" || $notification->event == "project_task_deadline_overdue_reminder")) {
            ...
            $task_deadline = $ci->Responsibility_model->get_one($task_deadline)->deadline;
            ...
            foreach ($notification_multiple_tasks_user_wise as $user_id => $tasks) {
                ...
                $table = view("responsibility/notification_multiple_tasks_table", array("tasks" => $tasks));
