...
class Stripe {
    ...
    public function __construct() {
        ...
        $this->Patrons_model = model("App\Models\Patrons_model");
        $this->Membership_model = model("App\Models\Membership_model");
    ...
    private function get_customer_id($client_id, $contact_user_id) {
        ...
        if ($client_info->stripe_customer_id) {
            ...
            $this->Patrons_model->ci_save($client_data, $client_id);
