...
class Responsibility_model extends Crud_model {
    ...
    function schema() {
        ...
        return array(
            ...
            "status_id" => array(
                "label" => app_lang("status"),
                "type" => "foreign_key",
                "linked_model" => model("App\Models\Responsibility_status_model"),
                "label_fields" => array("title"),
            ),
            "start_date" => array(
            ...
            "ticket_id" => array(
                ...
                "type" => "foreign_key",
                "linked_model" => model("App\Models\Tokens_model"),
                "label_fields" => array("title"),
            ),
            "no_of_cycles" => array(
            ...
            "priority_id" => array(
                "label" => app_lang("priority"),
                "type" => "foreign_key",
                "linked_model" => model("App\Models\Responsibility_priority_model"),
                "label_fields" => array("title"),
            ),
        );
    }
