...
class Project_comments_model extends Crud_model {
    ...
    private $Responsibility_model;

    function __construct() {
        $this->Project_files_model = model("App\Models\Project_files_model");
        $this->Responsibility_model = model("App\Models\Responsibility_model");
    ...
    function schema() {
        return array(
            ...
            "project_id" => array(
                ...
                "type" => "foreign_key",
                "linked_model" => model("App\Models\Enterprises_model"),
                "label_fields" => array("title"),
            ),
            "task_id" => array(
                "label" => app_lang("task"),
                "type" => "foreign_key",
                "linked_model" => model("App\Models\Responsibility_model"),
