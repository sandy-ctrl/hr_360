...
class Bill_items_model extends Crud_model {

    protected $table = null;
    private $_Bills_model = null;

    function __construct() {
        $this->table = 'invoice_items';
        parent::__construct($this->table);

        $this->_Bills_model = model("App\Models\Bills_model");
    }
    ...
    function save_item_and_update_invoice($data, $id, $invoice_id) {
        ...
        $Bills_model->update_invoice_total_meta($invoice_id);
    ...
    function delete_item_and_update_invoice($id, $undo = false) {
        ...
        $Bills_model = model("App\Models\Bills_model");
        $Bills_model->update_invoice_total_meta($item_info->invoice_id);
