    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <?php if (($user_info->id == $login_user->id) || $login_user->is_admin) { ?> 
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="password" class=" control-label"><?php echo app_lang('password'); ?></label>
                                <div class=" col-md-12">
                                    <?php
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="retype_password" class=" control-label"><?php echo app_lang('retype_password'); ?></label>
                                <div class=" col-md-12">
                                    <?php
                                    echo form_password(array(
                                        "id" => "retype_password",
            ...
            <?php if ($user_info->user_type === "staff" && ($login_user->is_admin || (!$user_info->is_admin && get_array_value($login_user->permissions, "can_manage_user_role_and_permissions") && $login_user->id !== $user_info->id))) { ?>
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="role" class=" control-label"><?php echo app_lang('role'); ?></label>
                        <div class=" col-md-12">
                            <?php
            ...
            <?php if ((isset($can_activate_deactivate_team_members) && $can_activate_deactivate_team_members && $user_info->id !== $login_user->id) || ($user_info->user_type === "client" && isset($can_edit_clients) && $can_edit_clients && $user_info->id !== $login_user->id)) { ?>
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="disable_login" class="control-label"><?php echo app_lang('disable_login'); ?></label>
                        <div class="col-md-12">
                            <?php
            ...
            <?php if ($user_info->user_type === "client" && $login_user->is_admin) { ?>
                <div class="col-sm-6">
                    <div class="form-group hide" id="resend_login_details_section">
                        <label for="email_login_details" class="control-label"><?php echo app_lang('email_login_details'); ?></label>
                        <div class="col-md-12">
                            <?php
