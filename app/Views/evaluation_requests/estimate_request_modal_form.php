<?php echo form_open(get_uri("evaluation_requests/save_estimate_request_form"), array("id" => "estimate-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="assigned_to" class="control-label"><?php echo app_lang('auto_assign_estimate_request_to') ?></label>
                    <div class="col-md-12">
                        <?php
            ...
            <div class="col-sm-6">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="public" class="control-label"><?php echo app_lang('public'); ?></label>
                            &nbsp
                            <div class="col-md-12">
                                <?php
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="enable_attachment" class="control-label"><?php echo app_lang('enable_attachment'); ?></label>
                            &nbsp
                            <div class="col-md-12">
                                <?php
    ...
    $(document).ready(function () {
        ...
        $("#estimate-form").appForm({
            onSuccess: function (result) {
                if (result.newData) {
                    window.location = "<?php echo site_url('evaluation_requests/edit_estimate_form'); ?>/" + result.id;
                } else {
