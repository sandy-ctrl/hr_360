    ...
    <div class="card">
        <div class="page-title clearfix">
            ...
            <div class="title-button-group">
                <?php echo modal_anchor(get_uri("evaluation_requests/estimate_request_modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_form'), array("class" => "btn btn-default", "title" => app_lang('add_form'))); ?>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#estimate-form-main-table").appTable({
            source: '<?php echo_uri("evaluation_requests/estimate_forms_list_data") ?>',
            order: [[0, 'asc']],
            columns: [
