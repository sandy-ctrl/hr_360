<div id="page-content" class="page-wrapper clearfix">
    ...
    <div id="estimate-form-editable" class="card  p15 no-border clearfix" style="max-width: 1000px; margin: auto;">
        <div class="clearfix pl10 pr10">
            ...
            <?php echo anchor(get_uri("evaluation_requests/preview_estimate_form/" . $model_info->id), app_lang('preview'), array("class" => "btn btn-default round mt15 float-end", "title" => app_lang('preview'))); ?> 
        </div>
        ...
        <div class="p15">
            <div class='text-center'> <?php echo modal_anchor(get_uri("evaluation_requests/estimate_form_field_modal_form/" . $model_info->id), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_field'), array("class" => "btn btn-default round ", "title" => app_lang('add_field'))); ?> </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#estimate-form-table").appTable({
            source: '<?php echo_uri("evaluation_requests/estimate_form_filed_list_data/" . $model_info->id) ?>',
            order: [[1, "asc"]],
            hideTools: true,
            displayLength: 100,
            columns: [
            ...
            onInitComplete: function () {
                ...
                Sortable.create($selector[0], {
                    ...
                    onUpdate: function (e) {
                        ...
                        //update sort indexes
                        $.ajax({
                            url: '<?php echo_uri("evaluation_requests/update_form_field_sort_values/" . $model_info->id) ?>',
                            type: "POST",
