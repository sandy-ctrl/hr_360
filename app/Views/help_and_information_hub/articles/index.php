    ...
    <div class="card">
        <div class="page-title clearfix">
            ...
            <div class="title-button-group">
                <?php
                echo anchor(get_uri("support/article_form/" . $type), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_article'), array("class" => "btn btn-default", "title" => app_lang('add_article')));
                ?>
            </div>
        </div>
...
<?php } ?>
        ...
        $("#article-table").appTable({
            source: '<?php echo_uri("support/articles_list_data/" . $type) ?>',
            order: [[0, "desc"]],
            filterDropdown: [
