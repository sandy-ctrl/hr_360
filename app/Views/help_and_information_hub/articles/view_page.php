    ...
    <div class="view-container-large">
        <div class="row ">
            <div id="help-left-panel" class="col-md-3">
                <?php echo view("help_and_information_hub/search_box", array("type" => $type)); ?>
            ...
            <div class="col-md-9">
                <div id="help-page-content" class="card">
                    ...
                    if ($page_type == "articles_list_view") {
                        echo view("help_and_information_hub/articles/articles_list_view", array("category_info" => $category_info, "articles" => $articles));
                    } else if ($page_type == "article_view") {
                        echo view("help_and_information_hub/articles/article_view", array("article_info" => $article_info));
                    }
                    ?>
...
<?php } ?>
        ...
        $(".article_vote_button").click(function () {
            ...
            appLoader.show();
            $.ajax({
                url: "<?php echo get_uri("information_hub/article_helpful_status/") ?>" + articleId + "/" + feedbackStatus + "/",
                type: 'POST',
                dataType: "json",
