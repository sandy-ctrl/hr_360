<div class="sidebar sidebar-off">
    ...
    <?php
    if ($badge) {
        echo "<span class='badge rounded-pill $badge_class badge-rounded-restucture'>$badge</span>";
    }
    ?>
                    </a>
                        <?php
                        if ($submenu) {
                            ...
                            foreach ($submenu as $s_menu) {
                                ...
                                $sub_active_class = get_array_value($s_menu, "is_sub_active_menu") ? "active" : "";
                                ...
                                if ($s_menu_name) {
                                    ...
                                    ?>
                            <li class="<?= $sub_active_class; ?>">
                                <a <?php echo $sub_menu_target; ?> href="<?php echo $is_custom_menu_item ? $url : get_uri($url); ?>" class="<?= $sub_active_class; ?>">
