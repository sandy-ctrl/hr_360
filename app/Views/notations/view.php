...
<div class="modal-footer">
    ...
    if ($model_info->created_by == $login_user->id || $login_user->is_admin) {
        echo modal_anchor(get_uri("notations/modal_form"), "<i data-feather='edit-2' class='icon-16'></i> " . app_lang('edit_note'), array("class" => "btn btn-default", "data-post-id" => $model_info->id, "title" => app_lang('edit_note')));
    }
    ?>
