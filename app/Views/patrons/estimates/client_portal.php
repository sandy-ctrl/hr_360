    ...
    <div class="card clearfix">
        ...
        <ul id="client-estimate-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
            ...
            <?php if (isset($can_request_estimate) && $can_request_estimate) { ?>
                <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("evaluation_requests/estimate_requests_for_client/" . $client_id); ?>" data-bs-target="#esimate-requests-tab"><?php echo app_lang('estimate_requests'); ?></a></li>
                <div class="tab-title clearfix no-border">

                    <div class="title-button-group">
                        <?php echo modal_anchor(get_uri("evaluation_requests/request_an_estimate_modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('request_an_estimate'), array("class" => "btn btn-default", "title" => app_lang('request_an_estimate'))); ?>           
                    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#estimate-table").appTable({
            source: '<?php echo_uri("evaluations/estimate_list_data_of_client/" . $client_id) ?>',
            order: [[0, "desc"]],
