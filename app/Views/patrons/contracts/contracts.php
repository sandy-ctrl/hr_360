<div class="card rounded-0">
    <div class="tab-title clearfix">
        ...
        <div class="title-button-group">
            <?php echo modal_anchor(get_uri("agreements/modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_contract'), array("class" => "btn btn-default", "data-post-client_id" => $client_id, "title" => app_lang('add_contract'))); ?>
        </div>
    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#contract-table").appTable({
            source: '<?php echo_uri("agreements/contract_list_data_of_client/" . $client_id) ?>',
            order: [[0, "desc"]],
