    ...
    <div class="card">
        <div class="page-title clearfix">
            ...
            <div class="title-button-group">
                <?php echo anchor(get_uri("outlet"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_order'), array("class" => "btn btn-default", "id" => "add-order-btn")); ?> 
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#order-table").appTable({
            source: '<?php echo_uri("arrangements/order_list_data_of_client/" . $client_id) ?>',
            order: [[0, "desc"]],
