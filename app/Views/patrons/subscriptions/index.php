            ...
            <div class="tab-title clearfix">
                ...
                <div class="title-button-group">
                    ...
                    if ($can_edit_subscriptions) {
                        echo modal_anchor(get_uri("membership/modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_subscription'), array("class" => "btn btn-default mb0", "data-post-client_id" => $client_id, "title" => app_lang('add_subscription')));
                    }
                    ?>
                </div>
            </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#subscription-table").appTable({
            source: '<?php echo_uri("membership/subscription_list_data_of_client/" . $client_id) ?>',
            order: [[0, "desc"]],
            columns: [
