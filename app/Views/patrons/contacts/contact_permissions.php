<div class="tab-content">
    <?php echo form_open(get_uri("patrons/save_contact_permissions/" . $user_info->id), array("id" => "contact-permissions-form", "class" => "general-form dashed-row white", "role" => "form")); ?>
    <div class="card">
