<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group">
                <?php
                $label_column = isset($label_column) ? $label_column : "control-label";
                $field_column = isset($field_column) ? $field_column : "col-md-12";
                ?>
    ...
    ?>
        <div class="col-sm-6">
            <div class="form-group">
                <label for="login_password" class="control-label"><?php echo app_lang('password'); ?></label>
                <div class="col-md-12">
        ...
        <?php echo view("patrons/contacts/contact_permission_fields"); ?>
