<?php echo form_open(get_uri("budgets/save"), array("id" => "expense-form", "class" => "general-form", "role" => "form")); ?>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class=" form-group">
                    <label for="expense_date" class="control-label"><?php echo app_lang('date_of_expense'); ?></label>
                    <div class="col-md-12">
                        <?php
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="category_id" class="control-label"><?php echo app_lang('category'); ?></label>
                    <div class=" col-md-12">
                        <?php
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="title" class="control-label"><?php echo app_lang('amount'); ?></label>
                    <div class="col-md-12">
                        <?php
                        echo form_input(array(
                            "id" => "amount",
            ...
            <?php } else { ?>
                <?php if ($login_user->is_admin || $can_access_clients && $can_access_expenses) { ?>
                    ...
                    <?php } else { ?>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="expense_client_id" class="control-label"><?php echo app_lang('client'); ?></label>
                                <div class="col-md-12">
                                    <?php
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="expense_project_id" class="control-label"><?php echo app_lang('project'); ?></label>
                        <div class=" col-md-12">
                            <?php
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="expense_user_id" class="control-label"><?php echo app_lang('team_member'); ?></label>
                    <div class="col-md-12">
                        <?php
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="expense_recurring" class="control-label"><?php echo app_lang('recurring'); ?>  <span class="help" data-bs-toggle="tooltip" title="<?php echo app_lang('cron_job_required'); ?>"><i data-feather="help-circle" class="icon-16"></i></span></label>
                    <div class="col-md-9">
                        <?php
