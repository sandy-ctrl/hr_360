...
<div id="page-content" class="page-wrapper clearfix grid-button">
    <div class="card clearfix">
        <ul id="summary-summary-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs inner" role="tablist">
            ...
            <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("budgets/monthly_summary"); ?>" data-bs-target="#monthly-expenses-summary"><?php echo app_lang("monthly"); ?></a></li>
            <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("budgets/custom_summary"); ?>" data-bs-target="#custom-expenses-summary"><?php echo app_lang('custom'); ?></a></li>
            <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("budgets/yearly_chart"); ?>" data-bs-target="#yearly-chart"><?php echo app_lang('yearly_chart'); ?></a></li>
            <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("budgets/category_chart"); ?>" data-bs-target="#category-chart"><?php echo app_lang('category_chart'); ?></a></li>
        </ul>
...
<script type="text/javascript">
    loadExpensesSummaryTable = function (selector, dateRange) {
        ...
        $(selector).appTable({
            source: '<?php echo_uri("budgets/summary_list_data") ?>',
            order: [[0, "asc"]],
