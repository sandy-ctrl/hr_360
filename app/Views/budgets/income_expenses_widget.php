...
<div class="card bg-white <?php echo $custom_class; ?> dashboard-card-restructure">
    <div class="card-header clearfix">
        <!-- <i data-feather="pie-chart" class="icon-16"></i> --> &nbsp;<?php echo app_lang("income_vs_expenses"); ?> 
    </div>
    <div class="card-body rounded-bottom card-body-restructure">
        <div class="row">            
            <div class="col-md-5">
                <div class="mb-2"><?php echo app_lang("this_year"); ?></div>
                <div class="mb-1">
                    <div class="color-tag border-circle me-3 wh8" style="background-color: #FABFA2;"></div>
                    <span class="strong"><?php echo to_currency($current_year_info->income ? $current_year_info->income : 0); ?></span>
                </div>
                <div>
                    <div class="color-tag border-circle me-3 wh8" style="background-color: #9FD6FF;"></div>
...
<?php } ?>
        ...
        incomeExpensesChartContent = new Chart(incomeExpensesChart, {
            ...
            data: {
                ...
                datasets: [{
                        ...
                        borderColor: '#FABFA2',
                        backgroundColor: 'rgba(252, 201, 0, 0.2)',
                        borderWidth: 2,
                        fill: true,
                        data: income,
                        pointRadius: 0
                        ...
                        borderColor: '#9FD6FF',
                        backgroundColor: 'rgba(34, 161, 254, 0.2)',
                        borderWidth: 2,
                        fill: true,
                        data: expense,
                        pointRadius: 0
    ...
    var prepareExpensesChart = function (data) {
        ...
        $.ajax({
            url: "<?php echo_uri("budgets/income_vs_expenses_chart_data") ?>",
            data: data,
            cache: false,
            type: 'POST',
            dataType: "json",
