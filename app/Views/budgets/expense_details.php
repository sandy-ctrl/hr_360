<div class="modal-body clearfix general-form">
    ...
    <div class="container-fluid">
        <div class="clearfix">
            <div class="row">
                <div class="col-md-12">
                    <ul id="expense-tabs" data-bs-toggle="ajax-tab" class="nav nav-pills nav-pills-restructre rounded classic mb20 scrollable-tabs border-white" role="tablist">
                        ...
                        <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("budgets/tasks/" . $expense_info->id); ?>" data-bs-target="#expenses-tasks-section"><?php echo app_lang('tasks'); ?></a></li>
                    </ul>
                </div>
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane fade active show" id="expenses-details-section">
                        ...
                        <?php if ($expense_info->project_title) { ?>
                            <div class="col-md-12 mb15">
                                <strong><?php echo app_lang('project') . ": "; ?> </strong> <?php echo anchor(get_uri("enterprises/view/" . $expense_info->project_id), $expense_info->project_title); ?>
                            </div>
                        <?php } ?>
                        ...
                        <?php if ($expense_info->recurring_expense_id) { ?>
                            <div class="col-md-12 mb15">
                                ...
                                <?php
                                echo modal_anchor(get_uri("budgets/expense_details"), app_lang("original_expense"), array("title" => app_lang("expense_details"), "data-post-id" => $expense_info->recurring_expense_id));
                                ?>
                            </div>
                        <?php } ?>
...
<div class="modal-footer">
    <?php
    echo modal_anchor(get_uri("budgets/modal_form"), "<i data-feather='copy' class='icon-16'></i> " . app_lang('clone_expense'), array("class" => "btn btn-default float-start", "data-post-is_clone" => true, "data-post-id" => $expense_info->id, "title" => app_lang('clone_expense')));
    echo modal_anchor(get_uri("budgets/modal_form"), "<i data-feather='edit' class='icon-16'></i> " . app_lang('edit_expense'), array("class" => "btn btn-default", "data-post-id" => $expense_info->id, "title" => app_lang('edit_expense')));
    ?>
