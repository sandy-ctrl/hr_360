<div class="reports-tabs">
    <div class="page-wrapper pb-0" style="background: #F5F5F5;">
        <?php
        foreach ($reports_menu as $report_menu) {
            ...
            if (!$single_button) {
                ...
                <div class="dropdown btn-group me-2">
                    <button class="btn btn-default round dropdown-toggle caret" type="button" data-bs-toggle="dropdown" aria-expanded="true" style="width: fit-content;">
