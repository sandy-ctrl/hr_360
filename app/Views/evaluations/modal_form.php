<?php echo form_open(get_uri("evaluations/save"), array("id" => "estimate-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-6">            
                <div class="form-group">
                    <label for="estimate_date" class=" control-label"><?php echo app_lang('estimate_date'); ?></label>
                    <div class="col-md-12">
                        <?php
        ...
        <?php } else { ?>
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="estimate_client_id" class=" control-label"><?php echo app_lang('client'); ?></label>
                    <div class="col-md-12">
                        <?php
        ...
        <div class="col-sm-6">
            <div class="form-group">
                <label for="estimate_note" class=" control-label"><?php echo app_lang('note'); ?></label>
                <div class=" col-md-12">
                    <?php
        ...
        $("#estimate-form").appForm({
            onSuccess: function (result) {
                if (typeof RELOAD_VIEW_AFTER_UPDATE !== "undefined" && RELOAD_VIEW_AFTER_UPDATE) {
                    ...
                    window.location = "<?php echo site_url('evaluations/view'); ?>/" + result.id;
                }
            }
        });
