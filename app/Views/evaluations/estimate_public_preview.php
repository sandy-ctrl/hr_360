                        ...
                        <div class="clearfix">
                            ...
                            <?php } else { ?>
                                ...
                                <div class="strong float-end mt4">
                                    <?php echo ajax_anchor(get_uri("evaluation/update_estimate_status/$estimate_info->id/$estimate_info->public_key/declined"), "<i data-feather='x-circle' class='icon-16'></i> " . app_lang('reject'), array("class" => "btn btn-danger mr10", "title" => app_lang('reject_estimate'), "data-reload-on-success" => "1")); ?>
                                    <?php echo modal_anchor(get_uri("evaluation/accept_estimate_modal_form/$estimate_info->id/$estimate_info->public_key"), "<i data-feather='check-circle' class='icon-16'></i> " . app_lang('accept'), array("class" => "btn btn-success mr5", "title" => app_lang('accept_estimate'))); ?>
                                </div>
                            <?php } ?>
                        </div>
                    </div>
