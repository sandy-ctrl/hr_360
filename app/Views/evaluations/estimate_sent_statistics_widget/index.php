<div id="estimate-sent-statistics-container">
    <?php echo view("evaluations/estimate_sent_statistics_widget/widget_data"); ?>
</div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $(".load-currency-wise-estimate-data").click(function () {
            ...
            $.ajax({
                url: "<?php echo get_uri('evaluations/load_statistics_of_selected_currency') ?>" + "/" + currencyValue,
                type: 'POST',
                dataType: 'json',
