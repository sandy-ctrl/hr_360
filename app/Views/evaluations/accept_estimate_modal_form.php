<?php echo form_open(get_uri("evaluation/accept_estimate"), array("id" => "accept-estimate-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="name" class=" control-label"><?php echo app_lang('name'); ?></label>
                        <div class="col-md-12">
                            <?php
        ...
        <?php if (get_setting("add_signature_option_on_accepting_estimate")) { ?>
            <div class="form-group">
                <div class="row">
                    <label for="signature" class="control-label"><?php echo app_lang('signature'); ?></label>
                    <div class="col-md-9">
                        <div id="signature">
