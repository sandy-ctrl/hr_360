                    ...
                    <div style="max-width: 1000px; margin: auto;">
                        <div>
                            <div class="clearfix p20">
                                ...
                                if ($style === "style_3") {
                                    echo view('evaluations/estimate_parts/header_style_3.php', $data);
                                } else if ($style === "style_2") {
                                    echo view('evaluations/estimate_parts/header_style_2.php', $data);
                                } else {
                                    echo view('evaluations/estimate_parts/header_style_1.php', $data);
                                }
                                ?>
                            ...
                            <div class="clearfix">
                                ...
                                <div class="float-end pr15" id="estimate-total-section">
                                    <?php echo view("evaluations/estimate_total_section", array("is_estimate_editable" => $is_estimate_editable)); ?>
                                </div>
                            </div>
                            ...
                            if (get_setting("enable_comments_on_estimates") && !($estimate_info->status === "draft")) {
                                echo view("evaluations/comment_form");
                            }
                            ?>
            ...
            <div class="card p20">
                <div class="card-body">
                    <div id="estimate-status-bar">
                        <?php echo view("evaluations/estimate_status_bar"); ?>
                    </div>
                </div>
            </div>
