<div class="col-md-12 mb15">
    ...
    if ($estimate_info->is_lead) {
        ...
        echo (anchor(get_uri("initiates/view/" . $estimate_info->client_id), $estimate_info->company_name));
    } else {
        echo "<strong>" . app_lang("client") . ": </strong>";
        echo (anchor(get_uri("patrons/view/" . $estimate_info->client_id), $estimate_info->company_name));
    }
    ?>
</div>
<div class="col-md-12 mb15">
...
<?php if (!$estimate_info->estimate_request_id == 0) { ?>
    <div class="col-md-12 mb15">
        ...
        <?php echo (anchor(get_uri("evaluation_requests/view_estimate_request/" . $estimate_info->estimate_request_id), app_lang('estimate_request') . " - " . $estimate_info->estimate_request_id)); ?>
    </div>
<?php } ?>
<?php if ($estimate_info->project_id) { ?>
    <div class="col-md-12 mb15">
        <strong><?php echo app_lang('project') . ": "; ?></strong>
        <?php echo (anchor(get_uri("enterprises/view/" . $estimate_info->project_id), $estimate_info->project_title)); ?>
    </div>
<?php } ?>
