<div id="page-content" class="page-wrapper clearfix grid-button">
    ...
    <div class="card clearfix">
        <ul id="estimate-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs title" role="tablist">
            ...
            <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("evaluations/yearly/"); ?>" data-bs-target="#yearly-estimates"><?php echo app_lang('yearly'); ?></a></li>
            <div class="tab-title clearfix no-border estimate-page-title">
                <div class="title-button-group">
                    <?php echo modal_anchor(get_uri("evaluations/modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_estimate'), array("class" => "btn btn-default", "title" => app_lang('add_estimate'))); ?>
                </div>
            </div>
        </ul>
...
<script type="text/javascript">
    loadEstimatesTable = function (selector, dateRange) {
        ...
        $(selector).appTable({
            source: '<?php echo_uri("evaluations/list_data") ?>',
            order: [[0, "desc"]],
            dateRangeType: dateRange,
            filterDropdown: [{name: "status", class: "w150", options: <?php echo view("evaluations/estimate_statuses_dropdown"); ?>}, <?php echo $custom_field_filters; ?>],
            columns: [
