<script>
    ...
    function showHideTheBatchUpdateButton() {
        ...
        if (projectId) {
            ...
            $.ajax({
                url: '<?php echo_uri("responsibility/can_edit_task_of_the_project") ?>' + '/' + projectId,
                dataType: 'json',
                cache: false,
    ...
    $(document).ready(function () {
        ...
        $('body').on('click', '[data-act=batch-operation-task-checkbox]', function (e) {
            ...
            $batchUpdateBtn.attr("data-action-url", "<?php echo_uri("responsibility/batch_update_modal_form/"); ?>" + serializeOfArray);
