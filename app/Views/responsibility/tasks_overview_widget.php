<div class="card bg-white dashboard-card-restructure">
    ...
    <div class="card-body rounded-bottom card-body-restructure" id="<?php echo $type; ?>-widget">
        <div class="row">
            <div class="col-md-6">
                <canvas id="all-tasks-overview-chart-<?php echo $type; ?>" style="width: 100%; height: 200px;"></canvas>
            </div>
            <div class="col-md-6 pl20 <?php echo count($task_statuses) > 8 ? "" : "pt-4"; ?> task-overview-restructure">
                <?php
                foreach ($task_statuses as $task_status) {
                    ?>
                    <a href="<?php echo get_uri('responsibility/all_tasks/tasks_list/' . $task_status->status_id . "/0/$type"); ?>" class="text-default">
                        <div class="pb-2">
                ...
                <?php if ($expired_tasks) { ?>
                    <a href="<?php echo get_uri('responsibility/all_tasks/tasks_list/0/0/' . $type . '/expired'); ?>" class="text-default">
                        <div class="pb-2">
        ...
        <div class="position-absolute" style="bottom: 15px;">
            ...
            foreach ($task_priorities as $task_priority) {
                ?>
                <span class="me-5">
                    <a href="<?php echo get_uri('responsibility/all_tasks/tasks_list/0/' . $task_priority->priority_id . "/$type"); ?>" class="text-default">
