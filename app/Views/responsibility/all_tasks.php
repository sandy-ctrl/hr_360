<div id="page-content" class="page-wrapper clearfix grid-button all-tasks-view">
    ...
    <ul id="task-tabs" class="nav nav-tabs title" role="tablist">
        <li class="title-tab my-tasks"><h4 class="pl15 pt10 pr15"><?php echo app_lang("tasks"); ?></h4></li>

        <?php echo view("responsibility/tabs", array("active_tab" => "tasks_list", "selected_tab" => $tab)); ?>
        ...
        <div class="tab-title clearfix no-border">
            <div class="title-button-group">
                ...
                if ($can_create_tasks) {
                    echo modal_anchor(get_uri("responsibility/import_modal_form"), "<i data-feather='upload' class='icon-16'></i> " . app_lang('import_tasks'), array("class" => "btn btn-default", "title" => app_lang('import_tasks')));
...
if ($preview_task_id) {
    echo modal_anchor(get_uri("responsibility/view"), "", array("id" => "preview_task_link", "title" => app_lang('task_info') . " #$preview_task_id", "data-post-id" => $preview_task_id));
}
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#task-table").appTable({
            source: '<?php echo_uri("responsibility/all_tasks_list_data") ?>',
            serverSide: true,
            order: [[1, "desc"]],
            ...
            filterDropdown: [
                {name: "quick_filter", class: "w200", showHtml: true, options: <?php echo view("responsibility/quick_filters_dropdown"); ?>},
                ...
                {name: "milestone_id", class: "w200", options: [{id: "", text: "- <?php echo app_lang('milestone'); ?> -"}], dependency: ["project_id"], dataSource: '<?php echo_uri("responsibility/get_milestones_for_filter") ?>'}, //milestone is dependent on project
...
<?php echo view("responsibility/task_table_common_script"); ?>
<?php echo view("responsibility/update_task_read_comments_status_script"); ?>
