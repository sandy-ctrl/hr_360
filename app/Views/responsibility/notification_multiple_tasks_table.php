<table style="width: 100%; color: #444; border-spacing: 0">
    ...
    <tbody>
        ...
        foreach ($tasks as $task) {
            ...
            ?>
            <tr>
                <td style="border: 1px solid #ddd; padding: 8px 10px; border-top: none; border-right: none"><?php echo anchor(get_uri("responsibility/view/$task_id"), app_lang("task") . " " . $task_id); ?></td>
