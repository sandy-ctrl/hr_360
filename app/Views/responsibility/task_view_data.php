            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <?php if ($model_info->ticket_id && $model_info->project_id) { ?>
                        <div class="col-md-12 mb15">
                            <strong><?php echo app_lang("ticket") . ": "; ?> </strong> <?php echo anchor(get_uri("tokens/view/" . $model_info->ticket_id), get_ticket_id($model_info->ticket_id) . " - " . $model_info->ticket_title); ?>
                        </div>
                    <?php } ?>
                    ...
                    <?php if ($model_info->recurring_task_id) { ?>
                        <div class="col-md-12 mb15">
                            ...
                            <?php
                            echo modal_anchor(get_uri("responsibility/view"), app_lang("task") . " " . $model_info->recurring_task_id, array("title" => app_lang('task_info') . " #$model_info->recurring_task_id", "data-post-id" => $model_info->recurring_task_id, "data-modal-lg" => "1"));
                            ?>
                        </div>
                    <?php } ?>
                    ...
                    <?php if ($model_info->context == "project") { ?>
                        <div class="col-md-12 mb15">
                            <?php
                            if ($show_timer) {
                                echo view("responsibility/task_timer");
                            }
                            ?> 
                        </div>
                        ...
                        <?php if (get_setting("module_project_timesheet") == "1" && $show_timesheet_info) { ?>
                            <div class="col-md-12 mb15">
                                ...
                                <?php
                                echo ajax_anchor(get_uri("enterprises/task_timesheet/" . $model_info->id . "/" . $model_info->project_id), $total_task_hours, array("data-real-target" => "#task-timesheet", "class" => "strong"));
                                ?>
                            </div>
                            <div class="col-md-12 mb15">
                    ...
                    <div class="col-md-12 mb15 <?php echo $pinned_status; ?>" id="pinned-comment">
                        ...
                        <?php echo view("enterprises/comments/pinned_comments"); ?>
                    </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <?php if ($model_info->parent_task_id) { ?>
                        <div class="col-md-12 mb15">
                            <strong><?php echo app_lang("main_task") . ": "; ?></strong><?php echo modal_anchor(get_uri("responsibility/view"), $parent_task_title, array("title" => app_lang('task_info') . " #$model_info->parent_task_id", "data-post-id" => $model_info->parent_task_id, "data-modal-lg" => "1")); ?>
                        </div>
                    <?php } ?>
                    ...
                    <?php if ($model_info->project_id) { ?>
                        <div class="col-md-12 mb15">
                            <strong><?php echo app_lang('project') . ": "; ?> </strong> <?php echo anchor(get_uri("enterprises/view/" . $model_info->project_id), $model_info->project_title); ?>
                        </div>
                    <?php } ?>

                    <?php if ($model_info->client_id) { ?>
                        <div class="col-md-12 mb15">
                            <strong><?php echo app_lang('client') . ": "; ?> </strong> <?php echo anchor(get_uri("patrons/view/" . $model_info->client_id), $model_info->company_name); ?>
                        </div>
                    <?php } ?>

                    <?php if ($model_info->lead_id) { ?>
                        <div class="col-md-12 mb15">
                            <strong><?php echo app_lang('lead') . ": "; ?> </strong> <?php echo anchor(get_uri("initiates/view/" . $model_info->lead_id), $model_info->company_name); ?>
                        </div>
                    <?php } ?>

                    <?php if ($model_info->invoice_id) { ?>
                        <div class="col-md-12 mb15">
                            <strong><?php echo app_lang('invoice') . ": "; ?> </strong> <?php echo anchor(get_uri("bills/view/" . $model_info->invoice_id), $model_info->invoice_display_id); ?>
                        </div>
                    <?php } ?>

                    <?php if ($model_info->estimate_id) { ?>
                        <div class="col-md-12 mb15">
                            <strong><?php echo app_lang('estimate') . ": "; ?> </strong> <?php echo anchor(get_uri("evaluations/view/" . $model_info->estimate_id), get_estimate_id($model_info->estimate_id)); ?>
                        </div>
                    <?php } ?>

                    <?php if ($model_info->order_id) { ?>
                        <div class="col-md-12 mb15">
                            <strong><?php echo app_lang('order') . ": "; ?> </strong> <?php echo anchor(get_uri("arrangements/view/" . $model_info->order_id), get_order_id($model_info->order_id)); ?>
                        </div>
                    <?php } ?>

                    <?php if ($model_info->contract_id) { ?>
                        <div class="col-md-12 mb15">
                            <strong><?php echo app_lang('contract') . ": "; ?> </strong> <?php echo anchor(get_uri("agreements/view/" . $model_info->contract_id), $model_info->contract_title); ?>
                        </div>
                    <?php } ?>

                    <?php if ($model_info->proposal_id) { ?>
                        <div class="col-md-12 mb15">
                            <strong><?php echo app_lang('proposal') . ": "; ?> </strong> <?php echo anchor(get_uri("plans/view/" . $model_info->proposal_id), get_proposal_id($model_info->proposal_id)); ?>
                        </div>
                    <?php } ?>

                    <?php if ($model_info->subscription_id) { ?>
                        <div class="col-md-12 mb15">
                            <strong><?php echo app_lang('subscription') . ": "; ?> </strong> <?php echo anchor(get_uri("membership/view/" . $model_info->subscription_id), $model_info->subscription_title); ?>
                        </div>
                    <?php } ?>

                    <?php if ($model_info->expense_id) { ?>
                        <div class="col-md-12 mb15">
                            <strong><?php echo app_lang('expense') . ": "; ?> </strong> <?php echo modal_anchor(get_uri("budgets/expense_details"), ($model_info->expense_title ? $model_info->expense_title : format_to_date($model_info->expense_date, false)), array("title" => app_lang("expense_details"), "data-post-id" => $model_info->expense_id, "data-modal-lg" => "1")); ?>
                        </div>
                    <?php } ?>
                    ...
                    <!--checklist-->
                    <?php echo form_open(get_uri("responsibility/save_checklist_item"), array("id" => "checklist_form", "class" => "general-form", "role" => "form")); ?>
                    ...
                    <!--Sub tasks-->
                    <?php echo form_open(get_uri("responsibility/save_sub_task"), array("id" => "sub_task_form", "class" => "general-form", "role" => "form")); ?>
                    <div class="col-md-12 mb15 b-t">
                        <div class="pb10 pt10">
                    ...
                    <div class="col-md-12 mb15 <?php echo ($blocked_by || $blocking) ? "" : "hide"; ?>" id="dependency-area">
                        ...
                        <?php echo form_open(get_uri("responsibility/save_dependency_tasks"), array("id" => "dependency_tasks_form", "class" => "general-form hide", "role" => "form")); ?>
                    ...
                    <div class="clearfix">
                        <div class="b-t pt10 list-container">
                            <?php if ($can_comment_on_tasks) { ?>
                                <?php echo view("enterprises/comments/comment_form"); ?>
                            <?php } ?>
                            <?php echo view("enterprises/comments/comment_list"); ?>
                        </div>
                    </div>
                </div>
            </div>
