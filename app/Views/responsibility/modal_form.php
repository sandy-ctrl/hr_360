<?php echo form_open(get_uri("responsibility/save"), array("id" => "task-form", "class" => "general-form", "role" => "form")); ?>
<div id="tasks-dropzone" class="post-dropzone">
    <div class="modal-body clearfix">
        <div class="container-fluid">
            ...
            if ($show_contexts_dropdown) {
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="context" class="control-label"><?php echo app_lang('related_to'); ?></label>
                        <div class=" col-md-12">
                            <?php
                            echo form_dropdown(
                ...
                foreach ($contexts as $context) {
                    ...
                    <div class="col-sm-6">
                        <div class="form-group hide" id="<?php echo $context; ?>-dropdown">
                            <label for="<?php echo $context_id_key; ?>" class="control-label"><?php echo app_lang($context); ?></label>
                            <div class="col-md-12">
                                <?php
                                echo form_input(array(
                                    "id" => $context_id_key,
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="points" class="control-label"><?php echo app_lang('points'); ?>
            ...
            <div class="col-sm-6">
                <div class="form-group" id="milestones-dropdown">
                    <label for="milestone_id" class="control-label"><?php echo app_lang('milestone'); ?></label>
            ...
            <?php if ($show_assign_to_dropdown) { ?>
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="assigned_to" class="control-label"><?php echo app_lang('assign_to'); ?></label>
                        <div class="col-md-12" id="dropdown-apploader-section">
                            <?php
                            echo form_input(array(
                                "id" => "assigned_to",
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="collaborators" class="control-label"><?php echo app_lang('collaborators'); ?></label>
                        <div class="col-md-12" id="dropdown-apploader-section">
                            <?php
                            echo form_input(array(
                                "id" => "collaborators",
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="priority_id" class="control-label"><?php echo app_lang('priority'); ?></label>
                    <div class="col-md-12">
                        <?php
                        echo form_input(array(
                            "id" => "priority_id",
            ...
            <div class="clearfix">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="start_date" class="<?php echo $show_time_with_task ? "control-label" : "control-label" ?>"><?php echo app_lang('start_date'); ?></label>
                            <div class="<?php echo $show_time_with_task ? "col-md-12 col-sm-12" : "col-md-12" ?> form-group">
                                <?php
                                echo form_input(array(
                                    "id" => "start_date",
                                    "name" => "start_date",
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="start_time" class="control-label"><?php echo app_lang('start_time'); ?></label>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="deadline" class="<?php echo $show_time_with_task ? "control-label" : "control-label" ?>"><?php echo app_lang('deadline'); ?></label>
                            <div class="<?php echo $show_time_with_task ? "col-md-12 col-sm-12" : "col-md-12" ?> form-group">
                                <?php
                                echo form_input(array(
                                    "id" => "deadline",
                    ...
                    <?php if ($show_time_with_task) { ?>
                     <div class="col-sm-6">
                        <div class="form-group">
                            <label for="end_time" class="control-label"><?php echo app_lang('end_time'); ?></label>
                            <div class="col-md-12 col-sm-12 form-group">
                                <?php
            ...
            <?php if (get_setting("enable_recurring_option_for_tasks")) { ?>
                ...
                <div class="form-group">
                    <div class="row">
                        <label for="recurring" class="control-label"><?php echo app_lang('recurring'); ?>  <span class="help" data-bs-toggle="tooltip" title="<?php echo app_lang('cron_job_required'); ?>"><i data-feather="help-circle" class="icon-16"></i></span></label>
                        <div class=" col-md-12">
                            <?php
                ...
                <div id="recurring_fields" class="<?php if (!$model_info->recurring) echo "hide"; ?>"> 
                    <div class="form-group">
                        <div class="row">
                            <label for="repeat_every" class="control-label"><?php echo app_lang('repeat_every'); ?></label>
                            <div class="col-md-4">
                                <?php
                                echo form_input(array(
                                    "id" => "repeat_every",
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label for="no_of_cycles" class="control-label"><?php echo app_lang('cycles'); ?></label>
                            <div class="col-md-4">
                                <?php
                                echo form_input(array(
                                    "id" => "no_of_cycles",
    ...
    <div class="modal-footer">
        <div id="link-of-new-view" class="hide">
            <?php
            echo modal_anchor(get_uri("responsibility/view"), "", array("data-modal-lg" => "1"));
            ?>
        </div>
        ...
        window.taskForm = $("#task-form").appForm({
            ...
            onSuccess: function (result) {
                ...
                if (window.showAddNewModal) {
                    ...
                    if (addType === "multiple") {
                        //add multiple tasks
                        $taskViewLink.attr("data-action-url", "<?php echo get_uri("responsibility/modal_form"); ?>");
                        ...
                        //save and show
                        $taskViewLink.attr("data-action-url", "<?php echo get_uri("responsibility/view"); ?>");
...
<?php
echo view("responsibility/get_dropdowns_script", array(
