...
<div id="page-content" class="page-wrapper clearfix <?php echo $has_banner_image ? "pt0" : ""; ?>">
    <div class="<?php echo isset($login_user->id) ? "" : "container store-page"; ?>">
        <div class="clearfix mb15">
            ...
            <div class="float-end">
                <?php echo anchor(get_uri("outlet/process_order"), "<i data-feather='check-circle' class='icon-16'></i> " . app_lang("checkout"), array("id" => "item-checkout-button", "class" => "btn btn-success $checkout_button ml15")); ?>
            </div>
        ...
        <div class="row" id="items-container">
            <?php echo view("elements/items_grid_data"); ?>
        </div>
    </div>
</div>
...
<script>
    $(document).ready(function () {
        ...
        function getItemSuggestions() {
            ...
            $.ajax({
                url: "<?php echo get_uri('outlet/index/'); ?>",
        ...
        $("body").on("click", ".item-add-to-cart-btn", function () {
            ...
            $.ajax({
                url: "<?php echo get_uri('outlet/add_item_to_cart'); ?>" + "/" + itemId,
                data: {id: itemId},
                cache: false,
                type: 'POST',
                dataType: 'json',
