...
<div id="page-content" class="clearfix">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <?php if ($lead_info->type != "person") { ?>
                        <p> 
                            <?php
                            $client_link = anchor(get_uri("initiates/view/" . $lead_info->id), $lead_info->company_name, array("class" => "white-link"));

                            if ($login_user->user_type === "client") {
                                $client_link = anchor(get_uri("initiates/contact_profile/" . $login_user->id . "/company"), $lead_info->company_name, array("class" => "white-link"));
                            }
    ...
    <ul data-bs-toggle="ajax-tab" class="nav nav-tabs no-border-top-radius" role="tablist">
        <li><a data-bs-toggle="tab" role="presentation" href="<?php echo_uri("initiates/contact_general_info_tab/" . $user_info->id); ?>" data-bs-target="#tab-general-info"> <?php echo app_lang('general_info'); ?></a></li>
        <li><a data-bs-toggle="tab" role="presentation" href="<?php echo_uri("initiates/company_info_tab/" . $user_info->client_id); ?>" data-bs-target="#tab-company-info"> <?php echo ($lead_info->type == "person") ? app_lang('contact_info') : app_lang('company'); ?></a></li>
        <li><a data-bs-toggle="tab" role="presentation" href="<?php echo_uri("initiates/contact_social_links_tab/" . $user_info->id); ?>" data-bs-target="#tab-social-links"> <?php echo app_lang('social_links'); ?></a></li>
