<?php echo form_open(get_uri("initiates/save_as_client"), array("id" => "make-client-form", "class" => "general-form", "role" => "form")); ?>
    ...
    <div class="container-fluid">
        ...
        <div class="tab-content <?php echo $contacts ? "mt15" : ""; ?>">
            <div role="tabpanel" class="tab-pane active" id="lead-info-tab">
                <?php echo view("patrons/client_form_fields", $lead_info); ?>
                <?php echo view("initiates/custom_field_migration", $lead_info); ?>
            </div>
                ...
                <?php foreach ($contacts as $key => $value) { ?>
                    ...
                    <div class="lead-migration-contacts">
                        ...
                        <div id='contact-<?php echo $key; ?>' class='p15 b-t collapse <?php echo $collapse_in; ?>'>
                            <?php echo view("initiates/contacts/contact_general_info_fields_for_migration", array("model_info" => $value, "custom_fields" => $value->custom_fields)); ?>
                        </div>
                    </div>
                <?php } ?>
            </div>
