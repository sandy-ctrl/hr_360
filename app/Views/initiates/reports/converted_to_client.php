...
<div id="page-content" class="page-wrapper clearfix grid-button">
    <div class="card clearfix">
        <ul id="leads-reports-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs inner" role="tablist">
            ...
            <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("initiates/team_members_summary"); ?>" data-bs-target="#team-members-summary-tab"><?php echo app_lang('team_members_summary'); ?></a></li>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $("#converted-to-client-monthly-chart-filters").appFilters({
            source: '<?php echo_uri("initiates/converted_to_client_charts_data") ?>',
