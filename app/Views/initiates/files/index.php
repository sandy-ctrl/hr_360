<div class="card no-border-top-radius">
    <div class="tab-title clearfix">
        ...
        <div class="title-button-group">
            <?php
            echo modal_anchor(get_uri("initiates/file_modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_files'), array("class" => "btn btn-default", "title" => app_lang('add_files'), "data-post-client_id" => $client_id));
            ?>
        </div>
    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#client-file-table").appTable({
            source: '<?php echo_uri("initiates/files_list_data/" . $client_id) ?>',
            order: [[0, "desc"]],
            columns: [
