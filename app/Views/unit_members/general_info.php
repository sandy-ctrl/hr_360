    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="alternative_address" class=" control-label"><?php echo app_lang('alternative_address'); ?></label>
                        <div class=" col-md-12">
                            <?php
                            echo form_textarea(array(
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="alternative_phone" class=" control-label"><?php echo app_lang('alternative_phone'); ?></label>
                        <div class=" col-md-12">
                            <?php
                            echo form_input(array(
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="gender" class=" control-label"><?php echo app_lang('gender'); ?></label>
                        <div class=" col-md-12">
                            <?php
