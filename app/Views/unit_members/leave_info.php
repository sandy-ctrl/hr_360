...
?>">
    <ul id="team-member-leave-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
        ...
        <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("unit_members/yearly_leaves/"); ?>" data-bs-target="#team_member-yearly-leaves"><?php echo app_lang('yearly'); ?></a></li>
        ...
        <div role="tabpanel" class="tab-pane fade" id="team_member-monthly-leaves">
            ...
            <script type="text/javascript">
                loadMembersLeavesTable = function (selector, dateRange) {
                    $(selector).appTable({
                        source: '<?php echo_uri("vacates/all_application_list_data") ?>',
