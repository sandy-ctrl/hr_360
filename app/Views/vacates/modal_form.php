<?php echo form_open(get_uri("vacates/" . $form_type), array("id" => "leave-form", "class" => "general-form", "role" => "form")); ?>
<div id="leaves-dropzone" class="post-dropzone">
    <div class="modal-body clearfix">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="applicant_id" class=" control-label"><?php echo app_lang('team_member'); ?></label>
                        <div class=" col-md-12">
                            <?php
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="leave_type" class=" control-label"><?php echo app_lang('leave_type'); ?></label>
                        <div class=" col-md-12">
                            <?php
                ...
                <div class="col-sm-6">
                    <div class=" form-group">
                        <label for="duration" class=" control-label"><?php echo app_lang('duration'); ?></label>
                        <div class="col-md-12">
                ...
                <div id="single_day_section"  class="form-group date_section">
                    <div class="col-sm-6">
                        <label id="date_label" for="single_date" class=" control-label"><?php echo app_lang('date'); ?></label>
                        <div class="col-md-12">
                            <?php
                ...
                <div id="total_days_section" class="hide date_section">
                    <div class="col-sm-6">
                    <div class="form-group">
                            <label for="total_days" class="control-label"><?php echo app_lang('total_days'); ?></label>
                            <div class="col-md-12 total-days">
            ...
            <div id="hours_section" class="hide date_section">
                <div class="clearfix">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="hour_date" class=" control-label"><?php echo app_lang('date'); ?></label>
                                <div class="col-md-12">
                                    <?php
                                    echo form_input(array(
                                        "id" => "hour_date",
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="hours" class=" control-label"><?php echo app_lang('hours'); ?></label>
                                <div class=" col-md-12">
                                    <?php
            ...
            <div class="row">
                <div class="form-group">
                    <label for="reason" class="control-label"><?php echo app_lang('reason'); ?></label>
                    <div class=" col-md-12">
                        <?php
