                        ...
                        <td>
                            <div class="clearfix">
                                ...
                                foreach ($files as $key => $value) {
                                    ...
                                    echo "<div>";
                                    echo js_anchor(remove_file_prefix($file_name), array("data-toggle" => "app-modal", "data-sidebar" => "0", "data-url" => get_uri("vacates/file_preview/" . $leave_info->id . "/" . $key)));
                                    echo "</div>";
                                }
                                ?>
                            </div>
...
<?php echo form_open(get_uri("vacates/update_status"), array("id" => "leave-status-form", "class" => "general-form", "role" => "form")); ?>
