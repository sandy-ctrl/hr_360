        ...
        <div class="page-title clearfix">
            ...
            <div class="title-button-group">
                <?php if ($can_edit_subscriptions) { ?>                    
                    <?php echo modal_anchor(get_uri("membership/modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_subscription'), array("class" => "btn btn-default mb0", "title" => app_lang('add_subscription'))); ?>
                    <?php echo modal_anchor(get_uri("labels/modal_form"), "<i data-feather='tag' class='icon-16'></i> ", array("class" => "btn btn-default mb0", "title" => app_lang('manage_labels'), "data-post-type" => "subscription")); ?>
                <?php } ?>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#subscriptions-table").appTable({
            source: '<?php echo_uri("membership/list_data") ?>',
            order: [[0, "desc"]],
