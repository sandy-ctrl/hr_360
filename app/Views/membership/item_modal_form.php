<?php echo form_open(get_uri("membership/save_item"), array("id" => "subscription-item-form", "class" => "general-form", "role" => "form")); ?>
...
<script type="text/javascript">
    ...
    function applySelect2OnItemTitle() {
        $("#subscription_item_title").select2({
            showSearchBox: true,
            ajax: {
                url: "<?php echo get_uri("membership/get_subscription_item_suggestion"); ?>",
                type: 'POST',
                dataType: 'json',
                quietMillis: 250,
            ...
            if (e.val === "+") {
                ...
                $.ajax({
                    url: "<?php echo get_uri("membership/get_subscription_item_info_suggestion"); ?>",
