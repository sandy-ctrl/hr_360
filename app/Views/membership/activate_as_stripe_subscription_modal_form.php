<?php echo form_open(get_uri("membership/activate_as_stripe_subscription"), array("id" => "request-payment-method-form", "class" => "general-form", "role" => "form")); ?>
    ...
    $(document).ready(function () {
        ...
        $('#stripe_product').select2({data: <?php echo json_encode($stripe_products_dropdown); ?>}).on("change", function () {
            ...
            if ($(this).val()) {
                ...
                $.ajax({
                    url: "<?php echo get_uri('membership/get_prices_of_selected_product') ?>" + "/" + productId,
                    dataType: "json",
