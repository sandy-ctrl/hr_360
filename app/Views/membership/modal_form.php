<?php echo form_open(get_uri("membership/save"), array("id" => "subscription-form", "class" => "general-form", "role" => "form")); ?>
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="title" class=" control-panel"><?php echo app_lang('title'); ?></label>
                    <div class=" col-md-12">
                        <?php
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="subscription_bill_date" class=" control-label"><?php echo app_lang('first_billing_date'); ?> <span class="help" data-bs-toggle="tooltip" title="<?php echo app_lang('first_billing_date_cant_be_past_message'); ?>"><i data-feather="help-circle" class="icon-16"></i></span></label>
                    <div class="col-md-12">
            ...
            <?php if (count($companies_dropdown) > 1) { ?>
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="company_id" class="control-label"><?php echo app_lang('company'); ?></label>
                        <div class="col-md-12">
                            <?php
                            echo form_input(array(
                                "id" => "company_id",
            ...
            <?php } else { ?>
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="subscription_client_id" class=" control-label"><?php echo app_lang('client'); ?></label>
                        <div class="col-md-12">
                            <?php
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="tax_id" class="control-label"><?php echo app_lang('tax'); ?></label>
                    <div class="col-md-12">
                        <?php
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="tax_id" class="control-label"><?php echo app_lang('second_tax'); ?></label>
                    <div class="col-md-12">
                        <?php
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="repeat_type" class="control-label"><?php echo app_lang('repeat_type'); ?></label>
                    <div class="col-md-12">
                        <?php
                        echo form_input(array(
                            "id" => "repeat_every",
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="repeat_type" class="control-label"><?php echo app_lang(''); ?></label>
                        <div class="col-md-12">
                        <?php
                        echo form_dropdown(
                            "repeat_type",
            ...
            <div class="col-sm-6 hide"  id="next_recurring_date_container">
                <div class="form-group">
                    <label for="next_recurring_date" class=" control-label"><?php echo app_lang('next_recurring_date'); ?> </label>
                    <div class=" col-md-12">
                        <?php
                        echo form_input(array(
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="subscription_note" class="control-label"><?php echo app_lang('note'); ?></label>
                    <div class=" col-md-12">
                        <?php
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="subscription_labels" class="control-label"><?php echo app_lang('labels'); ?></label>
                    <div class=" col-md-12">
                        <?php
                        echo form_input(array(
        ...
        $("#subscription-form").appForm({
            onSuccess: function(result) {
                if (typeof RELOAD_VIEW_AFTER_UPDATE !== "undefined" && RELOAD_VIEW_AFTER_UPDATE) {
                    ...
                    window.location = "<?php echo site_url('membership/view'); ?>/" + result.id;
                }
            },
