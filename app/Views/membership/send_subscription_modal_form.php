<?php echo form_open(get_uri("membership/send_subscription"), array("id" => "send-subscription-form", "class" => "general-form", "role" => "form")); ?>
    ...
    <div class="modal-body clearfix">
        <div class="container-fluid">
            ...
            <div class="form-group ml15">
                <i data-feather="check-circle" class='icon-16' style="color: #5CB85C;"></i> <?php echo app_lang('attached') . ' ' . anchor(get_uri("membership/download_pdf/" . $subscription_info->id), preg_replace('/[^A-Za-z0-9\-]/', '-', get_subscription_id($subscription_info->id)) . ".pdf", array("target" => "_blank")); ?> 
            </div>
    ...
    $(document).ready(function () {
        ...
        $("#contact_id").select2().on("change", function () {
            ...
            if (contact_id) {
                ...
                appLoader.show();
                $.ajax({
                    url: "<?php echo get_uri('membership/get_send_subscription_template/' . $subscription_info->id) ?>" + "/" + contact_id + "/json",
                    dataType: "json",
