            ...
            if (this.value) {
                ...
                if (searchFieldValue === "todo") {
                    ...
                    if (searchFieldValue === "task") {
                        location = "<?php echo get_uri("responsibility/view"); ?>/" + this.value;
                    } else if (searchFieldValue === "project") {
                        location = "<?php echo get_uri("enterprises/view"); ?>/" + this.value;
                    } else if (searchFieldValue === "client") {
                        location = "<?php echo get_uri("patrons/view"); ?>/" + this.value;
                    }
