<?php echo form_open(get_uri("plans/save"), array("id" => "proposal-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="proposal_date" class=" control-label"><?php echo app_lang('proposal_date'); ?></label>
                    <div class="col-md-12">
                        <?php
        ...
        <?php } else { ?>
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="proposal_client_id" class="control-label"><?php echo app_lang("client") . "/" . app_lang("lead"); ?></label>
                    <div class="col-md-12">
                        <?php
        ...
        <div class="col-sm-6">
            <div class="form-group">
                <label for="proposal_note" class="control-label"><?php echo app_lang('note'); ?></label>
                <div class="col-md-12">
                    <?php
        ...
        $("#proposal-form").appForm({
            onSuccess: function (result) {
                if (typeof RELOAD_VIEW_AFTER_UPDATE !== "undefined" && RELOAD_VIEW_AFTER_UPDATE) {
                    ...
                    window.location = "<?php echo site_url('plans/view'); ?>/" + result.id;
                }
            }
        });
