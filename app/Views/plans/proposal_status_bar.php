<div class="col-md-12 mb15">
    ...
    if ($proposal_info->is_lead) {
        echo app_lang("lead") . ": ";
        echo (anchor(get_uri("initiates/view/" . $proposal_info->client_id), $proposal_info->company_name));
    } else {
        echo app_lang("client") . ": ";
        echo (anchor(get_uri("patrons/view/" . $proposal_info->client_id), $proposal_info->company_name));
    }
    ?>
</div>
<div class="col-md-12 mb15">
...
<?php if ($total_read_count) { ?>
    <div class="col-md-12 mb15">
        ...
        <?php
        echo ajax_anchor(get_uri("plans/email_view_report/" . $proposal_info->id), $total_read_count, array("data-real-target" => "#proposal-email-view-report", "class" => "strong"));
        ?>
    </div>
    <div class="col-md-12 mb15">
