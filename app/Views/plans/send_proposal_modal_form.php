<?php echo form_open(get_uri("plans/send_proposal"), array("id" => "send-proposal-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <div class="container-fluid">
        ...
        <div class="form-group ml15">
            ...
            ?>            
            <label for="attach_pdf"><?php echo app_lang('attach_pdf') . ' ' . anchor(get_uri("plans/download_pdf/" . $proposal_info->id . "/download"), preg_replace('/[^A-Za-z0-9\-]/', '-', get_proposal_id($proposal_info->id)) . ".pdf", array("target" => "_blank", "id" => "attachment-url")); ?></label>
        </div>
    ...
    $(document).ready(function () {
        ...
        $("#contact_id").select2().on("change", function () {
            ...
            if (contact_id) {
                ...
                appLoader.show();
                $.ajax({
                    url: "<?php echo get_uri('plans/get_send_proposal_template/' . $proposal_info->id) ?>" + "/" + contact_id + "/json",
                    dataType: "json",
