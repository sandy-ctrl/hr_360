                                    ...
                                    <div class="p15 b-t mb15 card">
                                        <div class="clearfix p20">
                                            ...
                                            <div class="row">
                                                <div class="col-md-5 mb15">
                                                    <?php echo view('plans/proposal_parts/proposal_from', $data); ?>
                                                </div>
                                                <div class="col-md-3">
                                                    <?php echo view('plans/proposal_parts/proposal_to', $data); ?>
                                                </div>
                                                <div class="col-md-4 text-right">
                                                    <?php echo view('plans/proposal_parts/proposal_info', $data); ?>
                                                </div>
                                            </div>
                                        ...
                                        <div class="clearfix">
                                            ...
                                            <div class="float-end pr15" id="proposal-total-section">
                                                <?php echo view("plans/proposal_total_section", array("is_proposal_editable" => $is_proposal_editable)); ?>
                                            </div>
                                        </div>
            ...
            <div class="card p20">
                <div class="card-body">
                    <div id="proposal-status-bar">
                        <?php echo view("plans/proposal_status_bar"); ?>
                    </div>
                </div>
            </div>

            <?php echo view("plans/signer_info") ?>
        </div>
    </div>
</div>