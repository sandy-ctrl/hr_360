<?php echo form_open(get_uri("plans/save_item"), array("id" => "proposal-item-form", "class" => "general-form", "role" => "form")); ?>
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group">
                <label for="proposal_item_title" class="control-label"><?php echo app_lang('item'); ?></label>
                <div class="col-md-12">
                    <?php
        ...
        <div class="col-sm-6">
            <div class="form-group">
                <label for="proposal_item_description" class="control-label"><?php echo app_lang('description'); ?></label>
                <div class=" col-md-12">
                    <?php
...
<script type="text/javascript">
    ...
    function applySelect2OnItemTitle() {
        $("#proposal_item_title").select2({
            showSearchBox: true,
            ajax: {
                url: "<?php echo get_uri("plans/get_proposal_item_suggestion"); ?>",
                type: 'POST',
                dataType: 'json',
                quietMillis: 250,
            ...
            if (e.val === "+") {
                ...
                $.ajax({
                    url: "<?php echo get_uri("plans/get_proposal_item_info_suggestion"); ?>",
                    data: {item_id: e.val},
                    cache: false,
                    type: 'POST',
                    dataType: "json",
