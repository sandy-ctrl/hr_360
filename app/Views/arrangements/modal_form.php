<?php echo form_open(get_uri("arrangements/save"), array("id" => "order-form", "class" => "general-form", "role" => "form")); ?>
        ...
        $("#order-form").appForm({
            onSuccess: function (result) {
                if (typeof RELOAD_VIEW_AFTER_UPDATE !== "undefined" && RELOAD_VIEW_AFTER_UPDATE) {
                    ...
                    window.location = "<?php echo site_url('arrangements/view'); ?>/" + result.id;
                }
            }
        });
