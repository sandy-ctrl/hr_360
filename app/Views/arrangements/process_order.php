<div id="page-content" class="page-wrapper clearfix">
    <div class="process-order-preview" id="process-order-preview">
        <div class="card">
            ...
            <?php echo form_open(get_uri("outlet/place_order"), array("id" => "place-order-form", "class" => "general-form", "role" => "form")); ?>
                    ...
                    <div class="clearfix">
                        <div class="float-start mt20">
                            ...
                            if (isset($login_user->id)) {
                                echo modal_anchor(get_uri("outlet/item_modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_item'), array("class" => "btn btn-info text-white", "title" => app_lang('add_item')));
                            }
                            ?>
                        </div>
                        <div class="float-end" id="order-total-section">
                            <?php echo view("arrangements/processing_order_total_section"); ?>
                        </div>
                    </div>
                </div>
            ...
            <div  id="order-dropzone" class="post-dropzone">
                ...
                <div class="card-footer clearfix">
                    ...
                    <?php echo anchor(get_uri("outlet"), "<i data-feather='search' class='icon-16'></i> " . app_lang('find_more_items'), array("class" => "btn btn-default float-end")); ?> 
                </div>
            </div>
            <?php echo form_close(); ?>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#order-item-table").appTable({
                source: '<?php echo_uri("outlet/item_list_data_of_login_user") ?>',
                order: [[0, "asc"]],
                hideTools: true,
                displayLength: 100,
                columns: [
