...
<div id="page-content" class="page-wrapper clearfix grid-button">
    <div class="card clearfix">
        <ul id="orders-summary-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs bg-white inner" role="tablist">
            ...
            <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("arrangements/monthly_orders_summary"); ?>" data-bs-target="#monthly-orders-summary"><?php echo app_lang('monthly'); ?></a></li>
            <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("arrangements/custom_orders_summary"); ?>" data-bs-target="#custom-orders-summary"><?php echo app_lang('custom'); ?></a></li>
        </ul>
...
<script type="text/javascript">
    loadOrdersSummaryTable = function (selector, dateRange) {
        ...
        $(selector).appTable({
            source: '<?php echo_uri("arrangements/orders_summary_list_data") ?>',
