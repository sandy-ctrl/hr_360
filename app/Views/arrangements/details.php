    ...
    <div class="row">
        <div class="col-md-9 d-flex align-items-stretch">
            <div class="card w-100">
                <div id="page-content" class="clearfix" style="background: #fff;">
                    <div style="max-width: 1000px; margin: auto;">
                        <div class="clearfix p20">
                            ...
                            if ($style === "style_3") {
                                echo view('arrangements/order_parts/header_style_3.php', $data);
                            } else if ($style === "style_2") {
                                echo view('arrangements/order_parts/header_style_2.php', $data);
                            } else {
                                echo view('arrangements/order_parts/header_style_1.php', $data);
                            }
                            ?>
                        ...
                        <div class="clearfix">
                            <div class="float-start mt20 ml15">
                                <?php echo modal_anchor(get_uri("outlet/item_modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_item'), array("class" => "btn btn-sales-action text-white", "title" => app_lang('add_item'), "data-post-order_id" => $order_info->id)); ?>
                            </div>
                            <div class="float-end pr15" id="order-total-section">
                                <?php echo view("arrangements/order_total_section"); ?>
                            </div>
                        </div>
        ...
        <div class="col-md-3 d-flex align-items-stretch">
            <div class="card p15 w-100">
                <div class="clearfix p20">
                    <div class="row">
                        <?php echo view("arrangements/order_info_section"); ?>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $("#order-item-table").appTable({
            source: '<?php echo_uri("arrangements/item_list_data/" . $order_info->id . "/") ?>',
            order: [[0, "asc"]],
            hideTools: true,
            displayLength: 100,
            columns: [
            ...
            onInitComplete: function () {
                ...
                Sortable.create($selector[0], {
                    ...
                    onUpdate: function (e) {
                        ...
                        //update sort indexes
                        $.ajax({
                            url: '<?php echo_uri("outlet/update_item_sort_values") ?>',
                            type: "POST",
