<div id="page-content" class="page-wrapper clearfix">
    <div class="card clearfix">
        <ul id="order-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs title" role="tablist">
            ...
            <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("arrangements/yearly"); ?>" data-bs-target="#yearly-orders"><?php echo app_lang('yearly'); ?></a></li>
            <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("arrangements/custom"); ?>" data-bs-target="#custom-orders"><?php echo app_lang('custom'); ?></a></li>
...
<script type="text/javascript">
    loadOrdersTable = function (selector, dateRange) {
        ...
        $(selector).appTable({
            source: '<?php echo_uri("arrangements/list_data") ?>',
            order: [[0, "desc"]],
            dateRangeType: dateRangeType,
            rangeDatepicker: rangeDatepicker,
            filterDropdown: [{name: "status_id", class: "w150", options: <?php echo view("arrangements/order_statuses_dropdown"); ?>}, <?php echo $custom_field_filters; ?>],
            columns: [
...
<?php echo $custom_field_headers; ?>,
    ...
    $(document).ready(function () {
        ...
        $("#add-order-btn").click(function () {
            window.location.href = "<?php echo get_uri("outlet"); ?>";
        });
    });

</script>

<?php echo view("arrangements/update_order_status_script"); ?>