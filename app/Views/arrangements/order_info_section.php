<div class="col-md-12 mb15">
    ...
    <?php echo (anchor(get_uri("patrons/view/" . $order_info->client_id), $order_info->company_name)); ?>
</div>
<div class="col-md-12 mb15">
...
<?php if ($order_info->project_id) { ?>
    <div class="col-md-12 mb15">
        ...
        <?php echo (anchor(get_uri("enterprises/view/" . $order_info->project_id), $order_info->project_title)); ?>
    </div>
<?php } ?>
