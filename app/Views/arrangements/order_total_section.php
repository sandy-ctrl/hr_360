<table id="order-item-table" class="table display dataTable text-right strong table-responsive">     
    ...
    $discount_row = "<tr>
                        ...
                        <td class='text-center option w100'>" . modal_anchor(get_uri("arrangements/discount_modal_form"), "<i data-feather='edit' class='icon-16'></i>", array("class" => "edit", "data-post-order_id" => $order_id, "title" => app_lang('edit_discount'))) . "<span class='p20'>&nbsp;&nbsp;&nbsp;</span></td>
                    </tr>";
