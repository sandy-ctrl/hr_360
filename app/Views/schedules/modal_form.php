<?php echo form_open(get_uri("schedules/save"), array("id" => "event-form", "class" => "general-form", "role" => "form")); ?>
        ...
        <div class="container-fluid">
            ...
            <div class="clearfix">
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        <div class="form-group">
                            <label for="end_date" class="control-label"><?php echo app_lang('end_date'); ?></label>
                            <?php
                                echo form_input(array(
                                    "id" => "end_date",
                                    "name" => "end_date",
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="location" class="control-label"><?php echo app_lang('location'); ?></label>
                        <?php
                            echo form_input(array(
                                "id" => "location",
                                "name" => "location",
                ...
                <div class=" col-md-6">
                    <div class="form-group">
                        <label for="event_labels" class="control-label"><?php echo app_lang('labels'); ?></label>
                        <?php
                            echo form_input(array(
                                "id" => "event_labels",
                                "name" => "labels",
            ...
            <?php echo view("custom_fields/form/prepare_context_fields", array("custom_fields" => $custom_fields, "label_column" => "control-label", "field_column" => " col-md-9")); ?> 
            ...
            <?php if ($can_share_events) { ?>
                ...
                <?php } else { ?>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="share_with" class="control-label"><?php echo app_lang('share_with'); ?></label>
                                    <div>
                                        <?php
            ...
            <div id="recurring_fields" class="<?php if (!$model_info->recurring) echo "hide"; ?>"> 
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="no_of_cycles" class=" col-md-3"><?php echo app_lang('cycles'); ?>
    ...
    $(document).ready(function () {
        ...
        function prepareShareWithClientContactsDropdown(clientId) {
            ...
            if (clientId) {
                ...
                $.ajax({
                    url: "<?php echo get_uri("schedules/get_all_contacts_of_client") ?>" + "/" + clientId,
                    dataType: "json",
