    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 clearfix">
                ...
                <?php if ($model_info->google_event_id) { ?>
                    <div class="float-end pb10 ">
                        ...
                        <?php echo anchor(get_uri("schedules/show_event_in_google_calendar/$model_info->google_event_id"), app_lang("open_in_google_calendar"), array("target" => "_blank")); ?>
                    </div>
                <?php } ?>
            ...
            <div class="col-md-12 pb10 ">
                ...
                <?php
                echo view("schedules/event_time");
                ?>
            </div>
            ...
            <?php if ($model_info->company_name && $login_user->user_type != "client") { ?>
                <div class="col-md-12 pb10 pt10 ">
                    ...
                    <?php
                    echo $model_info->is_lead ? anchor("initiates/view/" . $model_info->client_id, $model_info->company_name) : anchor("patrons/view/" . $model_info->client_id, $model_info->company_name);
                    ?>
                </div>
            <?php } ?>
...
<div class="modal-footer">
    ...
    if (isset($editable) && $editable === "1") {
        ...
        if ($login_user->id == $model_info->created_by || $login_user->is_admin) {
            ...
            echo modal_anchor(get_uri("schedules/modal_form"), "<i data-feather='edit' class='icon-16'></i> " . app_lang('edit_event'), array("class" => "btn btn-default", "data-post-encrypted_event_id" => $encrypted_event_id, "title" => app_lang('edit_event')));
        }
    }
        ...
        $('#delete_event').click(function () {
            ...
            $(this).appConfirmation({
                ...
                onConfirm: function () {
                    ...
                    $.ajax({
                        url: "<?php echo get_uri('schedules/delete') ?>",
                        type: 'POST',
                        dataType: 'json',
