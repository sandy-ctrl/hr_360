        ...
        <div class="col-sm-9 col-lg-10">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="language" class=" control-label"><?php echo app_lang('language'); ?></label>
                                <div class="col-md-12">
                                    <?php
                                    echo form_dropdown(
                                            "language", $language_dropdown, get_setting('language') ? get_setting('language') : "english", "class='select2 max'"
                                    );
                                    ?>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="timezone" class=" control-label"><?php echo app_lang('timezone'); ?></label>
                                <div class="col-md-12">
                                    <?php
                                    echo form_dropdown(
                                            "timezone", $timezone_dropdown, get_setting('timezone'), "class='select2 max'"
                                    );
                                    ?>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="date_format" class=" control-label"><?php echo app_lang('date_format'); ?></label>
                                <div class="col-md-12">
                                    <?php
                                    echo form_dropdown(
                                            "date_format", array(
                                        ...
                                        "m.d.Y" => "m.d.Y",
                                        "Y.m.d" => "Y.m.d",
                                            ), get_setting('date_format'), "class='select2 max'"
                                    );
                                    ?>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="time_format" class=" control-label"><?php echo app_lang('time_format'); ?></label>
                                <div class="col-md-12">
                                    <?php
                                    echo form_dropdown(
                                            "time_format", array(
                                        ...
                                        "small" => "12 am",
                                        "24_hours" => "24 hours"
                                            ), get_setting('time_format'), "class='select2 max'"
                                    );
                                    ?>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="first_day_of_week" class=" control-label"><?php echo app_lang('first_day_of_week'); ?></label>
                                <div class="col-md-12">
                                    <?php
                                    echo form_dropdown(
                                        ...
                                        "5" => app_lang("friday"),
                                        "6" => app_lang("saturday")
                                            ), get_setting('first_day_of_week'), "class='select2 max'"
                                    );
                                    ?>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="weekends" class=" control-label"><?php echo app_lang('weekends'); ?></label>
                                <div class="col-md-12">
                                    <?php
                                    $days_dropdown = array(
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="default_currency" class=" control-label"><?php echo app_lang('currency'); ?></label>
                                <div class="col-md-12">
                                    <?php
                                    echo form_dropdown(
                                            "default_currency", $currency_dropdown, get_setting('default_currency'), "class='select2 max'"
                                    );
                                    ?>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="currency_position" class=" control-label"><?php echo app_lang('currency_position'); ?></label>
                                <div class="col-md-12">
                                    <?php
                                    echo form_dropdown(
                                        ...
                                        "right" => app_lang("right")
                                            ), get_setting('currency_position'), "class='select2 max'"
                                    );
                                    ?>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="decimal_separator" class=" control-label"><?php echo app_lang('decimal_separator'); ?></label>
                                <div class="col-md-12">
                                    <?php
                                    echo form_dropdown(
                                            "decimal_separator", array("." => "Dot (.)", "," => "Comma (,)"), get_setting('decimal_separator'), "class='select2 max'"
                                    );
                                    ?>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="no_of_decimals" class=" control-label"><?php echo app_lang('no_of_decimals'); ?></label>
                                <div class="col-md-12">
                                    <?php
                                    echo form_dropdown(
                                        ...
                                        "0" => "0",
                                        "2" => "2"
                                            ), get_setting('no_of_decimals') == "0" ? "0" : "2", "class='select2 max'"
                                    );
                                    ?>
                                </div>
                            </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                                <label for="conversion_rate" class=" control-label"><?php echo app_lang('conversion_rate'); ?></label>
                                <div class="col-md-12">
                                                ...
                                                <div class="conversion-rate-form clearfix pb10 ml10 mr10">
                                                    <div class="row">
                                                        <div class="clearfix p0">
                                                            <?php
                                                            echo form_dropdown(
                                                                    "conversion_rate_currency[]", $currency_dropdown, $currency, "class='select2 max float-start mr10'"
                                                            );
                                                            ?>
