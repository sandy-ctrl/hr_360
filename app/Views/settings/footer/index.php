...
<div class="card-body">
    ...
    <div id="footer-details-area" class="<?php echo get_setting("enable_footer") ? "" : "hide"; ?>">
        <div class="form-group" id="footer-menu-input-area">
            <div class="row">
                <label for="footer_menus" class=" control-label"><?php echo app_lang('footer_menus'); ?></label>
                <div class="col-md-10">
        ...
        <div class="form-group">
            <div class="row">
                <label for="footer_copyright_text" class=" control-label"><?php echo app_lang('footer_copyright_text'); ?></label>
                <div class="col-md-12">
                    <?php
                    echo form_input(array(
