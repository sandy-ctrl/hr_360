                ...
                <ul data-bs-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
                    ...
                    <div class="tab-title clearfix no-border">
                        <div class="title-button-group">
                            <?php echo modal_anchor(get_uri("responsibility_status/modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_task_status'), array("class" => "btn btn-default", "title" => app_lang('add_task_status'), "id" => "task-status-button")); ?>
                        </div>
                    </div>
                </ul>
    ...
    $(document).ready(function () {
        ...
        $(".nav-tabs li").click(function () {
            ...
            if (activeField === "#task-status-tab") { //task status
                ...
                addButton.attr("data-action-url", "<?php echo get_uri("responsibility_status/modal_form"); ?>");
                ...
                addButton.attr("data-action-url", "<?php echo get_uri("responsibility_priority/modal_form"); ?>");
