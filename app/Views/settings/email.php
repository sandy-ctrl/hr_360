            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="email_protocol" class=" control-label"><?php echo app_lang('email_protocol'); ?></label>
                                <div class=" col-md-12">
                                    <?php
                        ...
                        <div class="col-sm-6">
                            <div id="email-send-from-name" class="form-group <?php echo get_setting('email_protocol') === "microsoft_outlook" ? "hide" : ""; ?>">
                                <label for="email_sent_from_name" class=" control-label"><?php echo app_lang('email_sent_from_name'); ?></label>
                                <div class="col-md-12">
                                    <?php
                    ...
                    <div id="mail-settings-area" class="form-group <?php echo (get_setting('email_protocol') === "mail" || !get_setting('email_protocol')) ? "" : "hide"; ?>">
                        <div class="row">
                            <label for="email_sent_from_address" class="control-label"><?php echo app_lang('email_sent_from_address'); ?></label>
                            <div class=" col-md-12">
                                <?php
                                echo form_input(array(
                    ...
                    <div id="smtp-settings-area" class="<?php echo get_setting('email_protocol') === "smtp" ? "" : "hide"; ?>">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="email_smtp_host" class=" control-label"><?php echo app_lang('email_smtp_host'); ?></label>
                                <div class="col-md-12">
                                    <?php
                                    echo form_input(array(
                                        "id" => "email_smtp_host",
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="email_smtp_user" class=" control-label"><?php echo app_lang('email_smtp_user'); ?></label>
                                <div class="col-md-12">
                                    <?php
                                    echo form_input(array(
                                        "id" => "email_smtp_user",
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="email_smtp_pass" class="control-label"><?php echo app_lang('email_smtp_password'); ?></label>
                                <div class="col-md-12">
                                    <?php
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="email_smtp_port" class="control-label"><?php echo app_lang('email_smtp_port'); ?></label>
                                <div class="col-md-12">
                                    <?php
                                    echo form_input(array(
                                        "id" => "email_smtp_port",
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="email_smtp_security_type" class="control-label"><?php echo app_lang('security_type'); ?></label>
                                <div class="col-md-12">
                                    <?php
                                    echo form_dropdown(
                    ...
                    <div id="microsoft-outlook-area" class="<?php echo get_setting('email_protocol') === "microsoft_outlook" ? "" : "hide"; ?>">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="outlook_smtp_client_id" class="control-label"><?php echo app_lang('google_client_id'); ?></label>
                                <div class=" col-md-12">
                                    <?php
                                    echo form_input(array(
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="outlook_smtp_client_secret" class="control-label"><?php echo app_lang('google_client_secret'); ?></label>
                                <div class=" col-md-12">
                                    <?php
                                    echo form_input(array(
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="redirect_uri" class="control-label"><i data-feather="alert-triangle" class="icon-16 text-warning"></i> <?php echo app_lang('remember_to_add_this_url_in_authorized_redirect_uri'); ?></label>
                                <div class=" col-md-12">
                                    <?php
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="send_test_mail_to" class="control-label"><?php echo app_lang('send_test_mail_to'); ?>
