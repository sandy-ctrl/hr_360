...
$settings_menu["access_permission"][] = array("name" => "team", "url" => "unit_members");
...
if (get_setting("module_expense") == "1") {
    $settings_menu["setup"][] = array("name" => "expense_categories", "url" => "budget_categories");
}
...
if (get_setting("module_ticket") == "1") {
    $settings_menu["setup"][] = array("name" => "tickets", "url" => "token_types");
}
