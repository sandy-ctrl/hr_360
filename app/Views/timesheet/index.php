<div id="page-content" class="page-wrapper clearfix grid-button">
    ...
    <div class="card">
        <ul id="attendance-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs title" role="tablist">
            ...
            <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("timesheet/custom/"); ?>" data-bs-target="#custom-attendance"><?php echo app_lang('custom'); ?></a></li>
            <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("timesheet/summary/"); ?>" data-bs-target="#summary-attendance"><?php echo app_lang('summary'); ?></a></li>
            <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("timesheet/summary_details/"); ?>" data-bs-target="#summary-attendance-details"><?php echo app_lang('summary_details'); ?></a></li>
            <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("timesheet/members_clocked_in/"); ?>" data-bs-target="#members-clocked-in"><?php echo app_lang('members_clocked_in'); ?></a></li>
            <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("timesheet/clock_in_out"); ?>" data-bs-target="#clock-in-out"><?php echo app_lang('clock_in_out'); ?></a></li>

            <div class="tab-title clearfix no-border time-card-page-title">
                <div class="title-button-group">
                    <?php echo modal_anchor(get_uri("timesheet/modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_attendance'), array("class" => "btn btn-default", "title" => app_lang('add_attendance'))); ?>
                </div>
            </div>
        </ul>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#attendance-table").appTable({
            source: '<?php echo_uri("timesheet/list_data/"); ?>',
            order: [[2, "desc"]],
