...
<div id="page-content" class="page-wrapper clearfix grid-button">
    <div class="card clearfix">
        <ul id="payment-summary-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs inner" role="tablist">
            ...
            <?php if ($can_access_clients) { ?>
                <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("bill_payments/clients_payment_summary/"); ?>" data-bs-target="#clients-payment-summary"><?php echo app_lang('clients_summary'); ?></a></li>
            <?php } ?>
        </ul>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#yearly-payment-summary-table").appTable({
            source: '<?php echo_uri("bill_payments/yearly_payment_summary_list_data") ?>',
            order: [[0, "asc"]],
