...
<div id="page-content" class="page-wrapper clearfix grid-button">
    <div class="card clearfix">
        <ul id="invoices-summary-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs inner" role="tablist">
            ...
            <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("bills/monthly_invoices_summary"); ?>" data-bs-target="#monthly-invoices-summary"><?php echo app_lang('monthly'); ?></a></li>
            <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("bills/custom_invoices_summary"); ?>" data-bs-target="#custom-invoices-summary"><?php echo app_lang('custom'); ?></a></li>
        </ul>
...
<script type="text/javascript">
    loadInvoicesSummaryTable = function (selector, dateRange) {
        ...
        $(selector).appTable({
            source: '<?php echo_uri("bills/invoices_summary_list_data") ?>',
