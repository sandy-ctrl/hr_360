<?php echo form_open(get_uri("bills/save"), array("id" => "invoice-form", "class" => "general-form", "role" => "form")); ?>
    ...
    <div class="modal-body clearfix">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="invoice_bill_date" class="control-label"><?php echo app_lang('bill_date'); ?></label>
                        <div class="col-md-12">
                            <?php
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="invoice_due_date" class="control-label"><?php echo app_lang('due_date'); ?></label>
                        <div class="col-md-12">
                            <?php
                            echo form_input(array(
                                "id" => "invoice_due_date",
            ...
            <?php } else { ?>
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="invoice_client_id" class="control-label"><?php echo app_lang('client'); ?></label>
                        <div class="col-md-12">
                            <?php
            ...
            <?php } else { ?>
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="invoice_project_id" class="control-label"><?php echo app_lang('project'); ?></label>
                        <div class="col-md-12" id="invoice-porject-dropdown-section">
                            <?php
                            echo form_input(array(
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="tax_id" class="control-label"><?php echo app_lang('tax_deducted_at_source'); ?></label>
                    <div class="col-md-12">
                        <?php
            ...
            <?php echo view("bills/recurring_fields"); ?>

            <div class="col-sm-6">
                <div class="form-group">
                    <label for="invoice_note" class="control-label"><?php echo app_lang('note'); ?></label>
                    <div class=" col-md-12">
                        <?php
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="invoice_labels" class="control-label"><?php echo app_lang('labels'); ?></label>
                    <div class=" col-md-12">
                        <?php
                        echo form_input(array(
                            "id" => "invoice_labels",
    ...
    $(document).ready(function () {
        ...
        $("#invoice-form").appForm({
            onSuccess: function (result) {
                if (typeof RELOAD_VIEW_AFTER_UPDATE !== "undefined" && RELOAD_VIEW_AFTER_UPDATE) {
                    ...
                    window.location = "<?php echo site_url('bills/view'); ?>/" + result.id;
                }
            },
        ...
        $("#invoice_client_id").select2().on("change", function () {
            ...
            if ($(this).val()) {
                ...
                $.ajax({
                    url: "<?php echo get_uri("bills/get_project_suggestion") ?>" + "/" + client_id,
                    dataType: "json",
