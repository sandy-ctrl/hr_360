    ...
    <div class="row">
                    ...
                    <div style="max-width: 1000px; margin: auto;">
                        <div class="clearfix p20">
                            ...
                            if ($invoice_style === "style_3") {
                                echo view('bills/invoice_parts/header_style_3.php', $data);
                            } else if ($invoice_style === "style_2") {
                                echo view('bills/invoice_parts/header_style_2.php', $data);
                            } else {
                                echo view('bills/invoice_parts/header_style_1.php', $data);
                            }
                            ?>
                        </div>
                        ...
                        <div class="clearfix">
                            ...
                            <div class="float-end pr15" id="invoice-total-section">
                                <?php echo view("bills/invoice_total_section", array("invoice_id" => $invoice_info->id, "can_edit_invoices" => $can_edit_invoices)); ?>
                            </div>
                        </div>
        ...
        <div class="col-md-3 d-flex align-items-stretch">
            <div class="card p15 w-100">
                <div class="clearfix p20">
                    <div class="row">
                        <?php echo view("bills/invoice_status_bar"); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#invoice-item-table").appTable({
            source: '<?php echo_uri("bills/item_list_data/" . $invoice_info->id . "/") ?>',
            order: [[0, "asc"]],
            hideTools: true,
            displayLength: 100,
            stateSave: false,
...
<?php if ($can_edit_invoices) { ?>
                    ...
                    Sortable.create($selector[0], {
                        ...
                        onUpdate: function (e) {
                            ...
                            //update sort indexes
                            $.ajax({
                                url: '<?php echo_uri("bills/update_item_sort_values") ?>',
                                type: "POST",
