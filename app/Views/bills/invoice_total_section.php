<table id="invoice-item-table" class="table display dataTable text-right strong table-responsive">
    ...
    if ($can_edit_invoices) {
        $discount_edit_btn = "<td class='text-center option w100'>" . modal_anchor(get_uri("bills/discount_modal_form"), "<i data-feather='edit' class='icon-16'></i>", array("class" => "edit", "data-post-invoice_id" => $invoice_id, "title" => app_lang('edit_discount'))) . "<span class='p20'>&nbsp;&nbsp;&nbsp;</span></td>";
