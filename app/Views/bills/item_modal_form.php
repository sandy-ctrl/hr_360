<?php echo form_open(get_uri("bills/save_item"), array("id" => "invoice-item-form", "class" => "general-form", "role" => "form")); ?>
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="invoice_item_title" class=" control-label"><?php echo app_lang('item'); ?></label>
                    <div class="col-md-12">
                        <?php
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="invoice_item_quantity" class=" control-label"><?php echo app_lang('quantity'); ?></label>
                    <div class="col-md-12">
                        <?php
                        echo form_input(array(
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="invoice_unit_type" class=" control-label"><?php echo app_lang('unit_type'); ?></label>
                    <div class="col-md-12">
                        <?php
                        echo form_input(array(
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="invoice_item_rate" class=" control-label"><?php echo app_lang('rate'); ?></label>
                    <div class="col-md-12">
                        <?php
                        echo form_input(array(
...
<script type="text/javascript">
    ...
    function applySelect2OnItemTitle() {
        $("#invoice_item_title").select2({
            showSearchBox: true,
            ajax: {
                url: "<?php echo get_uri("bills/get_invoice_item_suggestion"); ?>",
                type: 'POST',
                dataType: 'json',
                quietMillis: 250,
            ...
            if (e.val === "+") {
                ...
                $.ajax({
                    url: "<?php echo get_uri("bills/get_invoice_item_info_suggestion"); ?>",
                    data: {item_id: e.val},
                    cache: false,
                    type: 'POST',
                    dataType: "json",
