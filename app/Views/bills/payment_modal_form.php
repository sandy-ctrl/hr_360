<?php echo form_open(get_uri("bill_payments/save_payment"), array("id" => "invoice-payment-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <div class="container-fluid">
        ...
        <?php } else { ?>
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="invoice_id" class="control-label"><?php echo app_lang('invoice'); ?></label>
                    <div class="col-md-12">
                        <?php
        ...
        <div class="col-sm-6">
            <div class="form-group">
                <label for="invoice_payment_method_id" class="control-label"><?php echo app_lang('payment_method'); ?></label>
                <div class="col-md-12">
                    <?php
                    helper('cookie');
        ...
        <div class="col-sm-6">
            <div class="form-group">
                <label for="invoice_payment_date" class="control-label"><?php echo app_lang('payment_date'); ?></label>
                <div class="col-md-12">
                    <?php
        ...
        <div class="col-sm-6">
            <div class="form-group">
                <label for="invoice_payment_amount" class="control-label"><?php echo app_lang('amount'); ?></label>
                <div class="col-md-12">
                    <?php
                    echo form_input(array(
        ...
        <div class="col-sm-6">
            <div class="form-group">
                <label for="invoice_payment_note" class="control-label"><?php echo app_lang('note'); ?></label>
                <div class=" col-md-12">
                    <?php
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#invoice_id").select2().on("change", function () {
            ...
            if ($(this).val()) {
                $.ajax({
                    url: "<?php echo get_uri("bill_payments/get_invoice_payment_amount_suggestion"); ?>" + "/" + invoice_id,
                    cache: false,
                    type: 'POST',
                    dataType: "json",
