...
if ($invoice_info->main_invoice_id) {
    echo "<br /><span class='invoice-meta text-default'>" . app_lang("main_invoice") . "</span>: " . anchor(get_uri("bills/preview/" . $invoice_info->main_invoice_id) . "/1", $invoice_info->main_invoice_display_id? $invoice_info->main_invoice_display_id : "", array("title" => app_lang("main_invoice"), "style" => "font-size: 90%; color: #666;"));
} else if ($invoice_info->credit_note_id) {
    echo "<br /><span class='invoice-meta text-default'>" . app_lang("credit_note") . "</span>: " . anchor(get_uri("bills/preview/" . $invoice_info->credit_note_id) . "/1", $invoice_info->credit_note_display_id? $invoice_info->credit_note_display_id : "", array("title" => app_lang("credit_note"), "style" => "font-size: 90%; color: #666;"));
}
