<table class="header-style" style="font-size: 13.5px;">
    <tr class="invoice-preview-header-row">
        <td style="width: 45%; vertical-align: top;">
            <?php echo view('bills/invoice_parts/company_logo'); ?>
        </td>
        ...
        <td class="invoice-info-container invoice-header-style-one" style="width: 35%; vertical-align: top; text-align: right"><?php
            ...
            echo view('bills/invoice_parts/invoice_info', $data);
            ?>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td><?php
            echo view('bills/invoice_parts/bill_from', $data);
            ?>
        </td>
        <td></td>
        <td><?php
            echo view('bills/invoice_parts/bill_to', $data);
            ?>
        </td>
    </tr>
</table>