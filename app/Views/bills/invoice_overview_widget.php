    ...
    <div class="card bg-white dashboard-card-restructure">
        <div class="card-header">
            ...
            <?php if ($currencies && $login_user->user_type == "staff") { ?>
                <div class="float-end">
                    <span class="float-end dropdown d-none">
        ...
        <div class="card-body rounded-bottom card-body-restructure" id="invoice-overview-container">
            <a href="<?php echo get_uri('bills/index/custom#overdue'); ?>" data-filter="overdue" class="text-default">
                <div class="d-flex p-2 p-2-restructure" style="border-bottom: 0.3px solid #A3A3A3;;">
                    <div class="w40p text-truncate" style="border-right: 0.5px solid #FE5F10;">
                        <div style="background-color: #FE5F10;" class="color-tag wh8"></div><?php echo app_lang("overdue"); ?>
                    </div>
                    <!-- <div class="w20p">
                    ...
                    <div class="w20p text-center" style="border-right: 0.5px solid #FE5F10;"><?php echo $overdue_invoices; ?></div>
                    <div class="w40p text-end"><?php echo to_currency($invoices_info->overdue, $currency_symbol); ?></div>
                </div>
            </a>
            <a href="<?php echo get_uri('bills/index/custom#not_paid'); ?>" data-filter="not_paid" class="text-default">
                <div class="d-flex p-2 p-2-restructure" style="border-bottom: 0.3px solid #A3A3A3;;">
                    <div class="w40p text-truncate" style="border-right: 0.5px solid #FE5F10;">
                        <div style="background-color: #FE5F10;" class="color-tag wh8"></div><?php echo app_lang("not_paid"); ?>
                    </div>
                    <!-- <div class="w20p">
                    ...
                    <div class="w20p text-center" style="border-right: 0.5px solid #FE5F10;"><?php echo $not_paid_invoices; ?></div>
                    <div class="w40p text-end"><?php echo to_currency($invoices_info->not_paid, $currency_symbol); ?></div>
                </div>
            </a>
            <a href="<?php echo get_uri('bills/index/custom#partially_paid'); ?>" data-filter="partially_paid" class="text-default">
                <div class="d-flex p-2 p-2-restructure" style="border-bottom: 0.3px solid #A3A3A3;;">
                    <div class="w40p text-truncate" style="border-right: 0.5px solid #FE5F10;">
                        <div style="background-color: #FE5F10;" class="color-tag wh8"></div><?php echo app_lang("partially_paid"); ?>
                    </div>
                    <!-- <div class="w20p">
                    ...
                    <div class="w20p text-center" style="border-right: 0.5px solid #FE5F10;"><?php echo $partially_paid_invoices; ?></div>
                    <div class="w40p text-end"><?php echo to_currency($invoices_info->partially_paid_total, $currency_symbol); ?></div>
                </div>
            </a>
            <a href="<?php echo get_uri('bills/index/custom#fully_paid'); ?>" data-filter="fully_paid" class="text-default">
                <div class="d-flex p-2 p-2-restructure" style="border-bottom: 0.3px solid #A3A3A3;;">
                    <div class="w40p text-truncate" style="border-right: 0.5px solid #FE5F10;">
                        <div style="background-color: #FE5F10;" class="color-tag wh8"></div><?php echo app_lang("fully_paid"); ?>
                    </div>
<!--                     <div class="w20p">
                    ...
                    <div class="w20p text-center" style="border-right: 0.5px solid #FE5F10;"><?php echo $fully_paid_invoices; ?></div>
                    <div class="w40p text-end"><?php echo to_currency($invoices_info->fully_paid_total, $currency_symbol); ?></div>
                </div>
            </a>
            <a href="<?php echo get_uri('bills/index/custom#draft'); ?>" data-filter="draft" class="text-default">
                <div class="d-flex p-2 p-2-restructure" style="border-bottom: 0.3px solid #A3A3A3;">
                    <div class="w40p text-truncate" style="border-right: 0.5px solid #FE5F10;">
                        <div style="background-color: #FE5F10;" class="color-tag wh8"></div><?php echo app_lang("draft"); ?>
                    </div>
                    <!-- <div class="w20p">
                    ...
                    <div class="w20p text-center" style="border-right: 0.5px solid #FE5F10;"><?php echo $draft_invoices; ?></div>
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-7 col-7">
                            <div style="color: #EC591B;"><?php echo app_lang("last_12_months"); ?></div>
...
<script>
    $(document).ready(function () {
        ...
        $(".load-currency-wise-data-for-invoice-overview").click(function () {
            ...
            $.ajax({
                url: "<?php echo get_uri('bills/load_invoice_overview_statistics_of_selected_currency') ?>" + "/" + currencyValue + "/" + currencySymbol,
                type: 'POST',
                dataType: 'json',
