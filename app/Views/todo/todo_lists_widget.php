    ...
    <div class="widget-todo-input-box mb0 todo-input-box">
        ...
        <div class="input-group pb15">
            ...
            <span class="input-group-btn">
                <button type="submit" class="btn btn-primary" style="border-radius: 0px 17px 17px 0px;"><!-- <span data-feather="check-circle" class="icon-16"></span> --> <?php echo app_lang('save'); ?></button>
            </span>
        </div>
