<?php echo form_open(get_uri("agreements/save_item"), array("id" => "contract-item-form", "class" => "general-form", "role" => "form")); ?>
...
<script type="text/javascript">
    ...
    function applySelect2OnItemTitle() {
        $("#contract_item_title").select2({
            showSearchBox: true,
            ajax: {
                url: "<?php echo get_uri("agreements/get_contract_item_suggestion"); ?>",
                type: 'POST',
                dataType: 'json',
                quietMillis: 250,
            ...
            if (e.val === "+") {
                ...
                $.ajax({
                    url: "<?php echo get_uri("agreements/get_contract_item_info_suggestion"); ?>",
                    data: {item_id: e.val},
                    cache: false,
                    type: 'POST',
                    dataType: "json",
