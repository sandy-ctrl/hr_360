<table id="contract-item-table" class="table display dataTable text-right strong table-responsive">     
    ...
    if ($is_contract_editable) {
        $discount_edit_btn = "<td class='text-center option w100'>" . modal_anchor(get_uri("agreements/discount_modal_form"), "<i data-feather='edit' class='icon-16'></i>", array("class" => "edit", "data-post-contract_id" => $contract_id, "title" => app_lang('edit_discount'))) . "<span class='p20'>&nbsp;&nbsp;&nbsp;</span></td>";
