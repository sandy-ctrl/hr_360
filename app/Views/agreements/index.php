<div id="page-content" class="page-wrapper clearfix grid-button">
    <div class="card clearfix">
        <ul id="contract-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs title" role="tablist">
            ...
            <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("agreements/yearly/"); ?>" data-bs-target="#yearly-contracts"><?php echo app_lang('yearly'); ?></a></li>
            <div class="tab-title clearfix no-border contracts-page-title">
                <div class="title-button-group">
                    <?php echo modal_anchor(get_uri("agreements/modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_contract'), array("class" => "btn btn-default", "title" => app_lang('add_contract'))); ?>
                </div>
            </div>
        </ul>
...
<script type="text/javascript">
    loadContractsTable = function (selector, dateRange) {
        $(selector).appTable({
            ...
            filterDropdown: [{name: "status", class: "w150", options: <?php echo view("agreements/contract_statuses_dropdown"); ?>}, <?php echo $custom_field_filters; ?>],
            columns: [
