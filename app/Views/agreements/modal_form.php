<?php echo form_open(get_uri("agreements/save"), array("id" => "contract-form", "class" => "general-form", "role" => "form")); ?>
    ...
    <div class="modal-body clearfix">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="contract_date" class=" control-label"><?php echo app_lang('contract_date'); ?></label>
                        <div class="col-md-12">
                            <?php
                            echo form_input(array(
                                "id" => "contract_date",
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="valid_until" class=" control-label"><?php echo app_lang('valid_until'); ?></label>
                        <div class="col-md-12">
                            <?php
                            echo form_input(array(
                                "id" => "valid_until",
            ...
            <?php } else { ?>
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="contract_client_id" class=" control-label"><?php echo app_lang("client") . "/" . app_lang("lead"); ?></label>
                        <div class="col-md-12">
                            <?php
            ...
            <?php } else { ?>
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="contract_project_id" class=" control-label"><?php echo app_lang('project'); ?></label>
                        <div class="col-md-12" id="contract-porject-dropdown-section">
                            <?php
                            echo form_input(array(
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="contract_note" class=" control-label"><?php echo app_lang('note'); ?></label>
                    <div class=" col-md-12">
                        <?php
    ...
    $(document).ready(function () {
        ...
        $("#contract-form").appForm({
            onSuccess: function (result) {
                if (typeof RELOAD_VIEW_AFTER_UPDATE !== "undefined" && RELOAD_VIEW_AFTER_UPDATE) {
                    ...
                    window.location = "<?php echo site_url('agreements/view'); ?>/" + result.id;
                }
            }
        });
        ...
        $("#contract_client_id").select2().on("change", function () {
            ...
            if ($(this).val()) {
                ...
                $.ajax({
                    url: "<?php echo get_uri("agreements/get_project_suggestion") ?>" + "/" + client_id,
                    dataType: "json",
