<div class="col-md-12 mb15">
    ...
    if ($contract_info->is_lead) {
        echo app_lang("lead") . ": ";
        echo (anchor(get_uri("initiates/view/" . $contract_info->client_id), $contract_info->company_name));
    } else {
        echo app_lang("client") . ": ";
        echo (anchor(get_uri("patrons/view/" . $contract_info->client_id), $contract_info->company_name));
    }
    ?>
</div>
<div class="col-md-12 mb15">
...
<?php if ($contract_info->project_id) { ?>
    <div class="col-md-12 mb15">
        ...
        <?php echo anchor(get_uri("enterprises/view/" . $contract_info->project_id), $contract_info->project_title); ?>
    </div>
<?php } ?>
