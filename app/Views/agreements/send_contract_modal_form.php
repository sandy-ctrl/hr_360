<?php echo form_open(get_uri("agreements/send_contract"), array("id" => "send-contract-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <div class="container-fluid">
        ...
        <div class="form-group ml15">
            ...
            ?>            
            <label for="attach_pdf"><?php echo app_lang('attach_pdf') . ' ' . anchor(get_uri("agreements/download_pdf/" . $contract_info->id . "/download"), preg_replace('/[^A-Za-z0-9\-]/', '-', get_contract_id($contract_info->id)) . ".pdf", array("target" => "_blank", "id" => "attachment-url")); ?></label>
        </div>
    ...
    $(document).ready(function () {
        ...
        $("#contact_id").select2().on("change", function () {
            ...
            if (contact_id) {
                ...
                appLoader.show();
                $.ajax({
                    url: "<?php echo get_uri('agreements/get_send_contract_template/' . $contract_info->id) ?>" + "/" + contact_id + "/json",
                    dataType: "json",
