<div class="box">
    <div class="box-content">
        <div id="timeline-content" class="page-wrapper clearfix mb20">
            <?php echo view("agenda/post_form"); ?>
                            ...
                            <div class="w-100 clearfix">
                                ...
                                <div class="float-end">
                                    ...
                                    if (get_setting("module_message")) {
                                        echo modal_anchor(get_uri("memos/modal_form/" . $member->id), "<i data-feather='mail' class='icon-16'></i>", array("class" => "btn btn-default btn-xs round send-message-btn", "title" => app_lang('send_message')));
                                    }
                                    ?>
                                </div>
                            </div>
