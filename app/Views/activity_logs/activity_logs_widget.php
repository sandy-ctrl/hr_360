...
foreach ($activity_logs as $log) {
    ...
    <div class ="row">
        <div class="d-flex border-bottom mb-3">
            <div class="col-sm-2">
                <div class="flex-shrink-0 me-2 mt-3" style="position: relative;">
                    <span class="avatar avatar-xs avatar-xs-restructure">
                    ...
                    <span class="float-end triangle-restructure"></span>
                </div>
            </div>
            <div class="col-sm-10">
                <div class="p-2 w-100">
                        ...
                        <div class="col-sm-5">
                            <div class="card-title text-center">
                                ...
                                if ($log->created_by_user) {
                                    if ($log->user_type === "staff") {
                                        echo get_team_member_profile_link($log->created_by, $log->created_by_user, array("class" => "dark strong project-timeline-title"));
                                    } else {
                            ...
                            <p class="text-center">
                                ...
                                if ($log->action === "created") {
                                    $label_class = "project-timeline-success-restructure";
                                    $log->action = "added";
                                } else if ($log->action === "updated") {
                                    $label_class = "project-timeline-warning-restructure";
                                ...
                                ?>
                            <span class="badge bg-<?php echo $label_class; ?>"><?php echo $log_caption; ?></span></p>
                        </div>
                        <div class="col-sm-7">
                            <span class="text-break"><?php
                                if ($log->log_type === "project_file") {
                                    ...
                                    if ($log->log_type === "task") {
                                        echo app_lang($log->log_type) . ": " . modal_anchor(get_uri("responsibility/view"), " #" . $log->log_type_id . " <br> " . convert_mentions(convert_comment_link(process_images_from_content($log->log_type_title))), array("title" => app_lang('task_info') . " #$log->log_type_id", "class" => "dark", "id" => "task-modal-view-link", "data-post-id" => $log->log_type_id, "data-modal-lg" => "1"));
                                    } else {
                                ...
                                <p> <?php
                                    if ($log->log_for2 === "task") {
                                        echo app_lang($log->log_for2) . ": " . modal_anchor(get_uri("responsibility/view"), " #" . $log->log_for_id2, array("title" => app_lang('task_info') . " #$log->log_for_id2", "class" => "dark", "data-post-id" => $log->log_for_id2, "data-modal-lg" => "1"));
                                    } else {
                            ...
                            <?php if ($log->action === "bitbucket_notification_received" || $log->action === "github_notification_received") { ?>
                                <p> <?php echo app_lang($log->log_type) . ": " . modal_anchor(get_uri("responsibility/view"), " #" . $log->log_type_id . " - " . convert_mentions($log->log_type_title), array("title" => app_lang('task_info') . " #$log->log_type_id", "class" => "dark", "data-post-id" => $log->log_type_id, "data-modal-lg" => "1")); ?></p>
                            <?php } ?>
...
<div id="<?php echo $next_container_id; ?>">
    <div class="text-center">
        ...
        if ($result_remaining > 0) {
            ...
            echo ajax_anchor(get_uri("enterprises/history/" . $next_page_offset . "/" . $log_for . "/" . $log_for_id . "/" . $log_type . "/" . $log_type_id), app_lang("load_more"), array("class" => "btn btn-default w-100 mt15 spinning-btn", "title" => app_lang("load_more"), "data-inline-loader" => "1", "data-real-target" => "#" . $next_container_id));
        }
        ?>
    </div>
</div>
