...
?>
    ...
    <div>
        ...
        <div class=" text-break strong"><?php echo js_anchor(remove_file_prefix($file_name), array('title' => "", "data-group" => "details", "data-toggle" => "app-modal", "data-sidebar" => "0", "data-url" => get_uri("files_directory/view_file/" . $file_info->id . "/" . $client_id))); ?></div>
