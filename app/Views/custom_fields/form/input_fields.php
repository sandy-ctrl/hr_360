...
<div class="row">
    ...
    <div class="col-sm-6">
        <div class="form-group">
            <label for="title_language_key" class=" control-label"><?php echo app_lang('title_language_key'); ?>
    ...
    <div class="col-sm-6">
        <div class="form-group">
            <label for="placeholder" class=" control-label"><?php echo app_lang('placeholder'); ?></label>
            <div class=" col-md-12">
                <?php
                echo form_input(array(
                    "id" => "placeholder",
    ...
    <div class="col-sm-6">
        <div class="form-group">
            <label for="placeholder_language_key" class=" control-label"><?php echo app_lang('placeholder_language_key'); ?>
                <span class="help" data-container="body" data-bs-toggle="tooltip" title="<?php echo app_lang('language_key_recommendation_help_text') ?>"><i data-feather="help-circle" class="icon-16"></i></span>
            </label>
            <div class=" col-md-12">
                <?php
    ...
    <div class="col-sm-6">
        <div class="form-group">
            <label for="example_variable_name" class=" control-label"><?php echo app_lang('email_template_variable'); ?></label>
            <div class=" col-md-12">
    ...
    <div class="col-sm-6">
        <div class="form-group">
            <label for="field_type" class=" control-label"><?php echo app_lang('field_type'); ?></label>
            <div class="col-md-12">
                <?php
                $disabled = "";
                if ($model_info->id) {
    ...
    <div class="col-sm-6">
        <div id="options_container" class="form-group">
            <label for="options" class=" control-label"><?php echo app_lang('options'); ?></label>
            <div class=" col-md-12">
                <?php
    ...
    <div class="col-sm-6">
        <div class="form-group">
        <label for="required" class=" control-label"><?php echo app_lang('required'); ?></label>
        <div class="col-md-12">
            <?php
            echo form_checkbox(
