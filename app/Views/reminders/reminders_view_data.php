...
<div id="<?php echo $reminder_id_prefix . 'reminder-form-container'; ?>" class="<?php echo $hide_form ? "hide" : ""; ?>">
    <?php echo form_open(get_uri("schedules/save"), array("id" => $reminder_id_prefix . "reminder_form", "class" => "general-form", "role" => "form")); ?>
    ...
    $(document).ready(function () {
        ...
        loadReminderTable = function (type) {
            ...
            $tableSelector.appTable({
                source: '<?php echo_uri("schedules/reminders_list_data") ?>/' + type + '/' + reminderContext + '/' + contextId,
                hideTools: true,
                order: [[0, "asc"]],
                displayLength: 100,
                columns: [
