...
<div id="page-content" class="page-wrapper clearfix grid-button">
    <div class="card clearfix">
        <ul id="tickets-reports-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs inner" role="tablist">
            ...
            <!--<li><a role="presentation" data-bs-toggle="tab" href="<?php // echo_uri("tokens/team_members_summary"); ?>" data-bs-target="#team-members-summary-tab"><?php //echo app_lang('team_members_summary'); ?></a></li>-->
        </ul>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $("#tickets-chart-filters").appFilters({
            source: '<?php echo_uri("tokens/tickets_chart_report_data") ?>',
