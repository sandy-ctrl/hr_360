<div id="page-content" class="page-wrapper clearfix grid-button">
    ...
    <ul id="token-tabs" class="nav nav-tabs title" role="tablist">
        <li class="title-tab"><h4 class="pl15 pt10 pr15"><?php echo app_lang('tickets'); ?></h4></li>

        <?php echo view("tokens/index", array("active_tab" => "tickets_list")); ?>
        ...
        <div class="tab-title clearfix no-border tickets-page-title">
            <div class="title-button-group">
                ...
                echo modal_anchor(get_uri("tokens/settings_modal_form"), "<i data-feather='settings' class='icon-16'></i> " . app_lang('settings'), array("class" => "btn btn-default", "title" => app_lang('settings')));
                echo modal_anchor(get_uri("tokens/modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_ticket'), array("class" => "btn btn-default", "title" => app_lang('add_ticket')));
                echo modal_anchor(get_uri("labels/modal_form"), "<i data-feather='tag' class='icon-16'></i> ", array("class" => "btn btn-default", "title" => app_lang('manage_labels'), "data-post-type" => "ticket"));
                ?>
            </div>
        </div>
...
<?php } ?>
        ...
        $("#ticket-table").appTable({
            source: '<?php echo_uri("tokens/list_data") ?>',
            serverSide: true,
            order: [[7, "desc"]],
...
<?php echo view("tokens/batch_update/batch_update_script"); ?>