<div id="page-content" class="page-wrapper pb0 clearfix">
    ...
    <ul class="nav nav-tabs bg-white title" role="tablist">
        ...
        <?php echo view("tokens/index", array("active_tab" => "ticket_templates")); ?>

        <div class="tab-title clearfix no-border">
            <div class="title-button-group">
                <?php echo modal_anchor(get_uri("tokens/ticket_template_modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_template'), array("class" => "btn btn-default", "title" => app_lang('add_template'))); ?>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#ticket-template-table").appTable({
            source: '<?php echo_uri("tokens/ticket_template_list_data") ?>',
            order: [[0, 'desc']],
            columns: [
