<?php echo form_open(get_uri("tokens/save"), array("id" => "ticket-form", "class" => "general-form", "role" => "form")); ?>
...
<?php if ($show_project_reference == "1") { ?>
            ...
            $("#client_id").select2().on("change", function () {
                ...
                if ($(this).val()) {
                    ...
                    $.ajax({
                        url: "<?php echo get_uri("tokens/get_project_suggestion") ?>" + "/" + client_id,
                        dataType: "json",
...
<?php } ?>
        ...
        $("#client_id").select2().on("change", function () {
            ...
            if ($(this).val()) {
                ...
                $.ajax({
                    url: "<?php echo get_uri("tokens/get_client_contact_suggestion") ?>" + "/" + client_id,
                    dataType: "json",
                    success: function (result) {
