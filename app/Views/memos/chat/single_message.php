...
if ($total_files) {
    ...
    $download_caption = anchor(get_uri("memos/download_message_files/" . $reply_info->id), "<i data-feather='paperclip' class='icon-16'></i>" . $download_lang, array("class" => "", "title" => $download_lang));
}
