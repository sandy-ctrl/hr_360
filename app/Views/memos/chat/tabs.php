        ...
        <ul class="chat-tab p0 m0 nav nav-tabs box"  data-bs-toggle="ajax-tab" role="tablist">
            ...
            <?php if ($show_users_list) { ?>
                <li class="box-content" id="chat-users-tab-button">
                    <a role="presentation"  href="<?php echo_uri("memos/users_list/staff"); ?>" data-bs-toggle="tab" data-bs-target="#chat-users-tab"> <i data-feather="user" class="icon-18"></i></a>
                </li>
            <?php } ?>

            <?php if ($show_clients_list) { ?>
                <li class="box-content" id="chat-clients-tab-button">
                    <a role="presentation"  href="<?php echo_uri("memos/users_list/client"); ?>" data-bs-toggle="tab" data-bs-target="#chat-clients-tab"><i data-feather="briefcase" class="icon-16"></i></a>
                </li>
            <?php } ?>
...
<div class="rise-chat-body long clearfix">
    <div class="tab-content">
        <div role="tabpanel" class="tab-pane fade" id="chat-inbox-tab">
            <?php echo view("memos/chat/chat_list", array("messages" => $messages)); ?>
        </div>
