...
<div id="js-single-user-chat-list" class="rise-chat-body full-height">
    ...
    <div class='clearfix p10 b-b'>
        ...
        if (get_setting("module_chat")) {
            echo modal_anchor(get_uri("memos/modal_form/" . $user_id), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang("new_conversation"), array("class" => "btn btn-default col-md-12 col-sm-12 col-xs-12", "title" => app_lang('send_message')));
        }
        ?>
    </div>
