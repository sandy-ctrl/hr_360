<div id="new-message-dropzone" class="post-dropzone">
    <?php echo form_open(get_uri("memos/send_message"), array("id" => "message-form", "class" => "general-form", "role" => "form")); ?>
    <div class="modal-body clearfix">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="to_user_id" class=" control-label"><?php echo app_lang('to'); ?></label>
                        <div class="col-md-12">
                            <?php
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="subject" class=" control-label"><?php echo app_lang('subject'); ?></label>
                        <div class=" col-md-12">
                            <?php
