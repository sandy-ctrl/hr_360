<div id="page-content" class="page-wrapper clearfix">
    ...
    <div class="row">
        ...
        <div class="box">
            <div class="box-content content-sidebar" style="padding:15px;">
                <ul class="list-group" style="display: ruby;">
                    <?php echo modal_anchor(get_uri("memos/modal_form"), app_lang('compose'), array("class" => "list-group-item", "title" => app_lang('send_message'))); ?> 

                    <?php echo anchor(get_uri("memos/inbox"), app_lang('inbox'), array("class" => "list-group-item")); ?>

                    <?php echo anchor(get_uri("memos/sent_items"), app_lang('sent_items'), array("class" => "list-group-item")); ?>
                </ul>
            </div>
        </div>
        <div class="row">    
                        ...
                        <div id="message-details-section" class="card"> 
                            <div id="empty-message" class="text-center mb15 box">
                                <div class="box-content" style="vertical-align: middle; height: 100%"> 
                                    <!-- <i data-feather="mail" width="10rem" height="10rem" style="color:rgba(119, 119, 119, 0.2)"></i> -->
                                    <img class="message-images-restructure" src="<?= base_url('assets/images/') ?>vector.png">
                                    <div class="message-view-footer-restructure"><?php echo app_lang("select_a_message"); ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#message-table").appTable({
            source: '<?php echo_uri("memos/list_data/" . $mode) ?>',
            order: [[1, "desc"]],
            columns: [
        ...
        $("body").on("click", "tr", function () {
            ...
            if (!$(this).hasClass("active")) {
                ...
                if (message_id) {
                    ...
                    $.ajax({
                        url: "<?php echo get_uri("memos/view"); ?>/" + message_id + "/<?php echo $mode ?>/" + reply,
                        dataType: "json",
