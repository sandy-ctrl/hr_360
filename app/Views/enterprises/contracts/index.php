<div class="card">
    <div class="tab-title clearfix">
        ...
        <div class="title-button-group">
            <?php
            echo modal_anchor(get_uri("agreements/modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_contract'), array("class" => "btn btn-default", "title" => app_lang('add_contract'), "data-post-project_id" => $project_id));
            ?>
        </div>
    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#contract-table").appTable({
            source: '<?php echo_uri("agreements/contract_list_data_of_project/" . $project_id) ?>',
            order: [[0, "desc"]],
