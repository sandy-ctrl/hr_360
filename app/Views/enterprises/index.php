        ...
        <div class="page-title clearfix projects-page">
            ...
            <div class="title-button-group">
                ...
                if ($can_create_projects) {
                    ...
                    echo modal_anchor(get_uri("enterprises/import_modal_form"), "<i data-feather='upload' class='icon-16'></i> " . app_lang('import_projects'), array("class" => "btn btn-default", "title" => app_lang('import_projects')));

                    echo modal_anchor(get_uri("enterprises/modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_project'), array("class" => "btn btn-default", "title" => app_lang('add_project')));

                    if ($can_edit_projects) {
                        echo modal_anchor(get_uri("labels/modal_form"), "<i data-feather='tag' class='icon-16'></i> ", array("class" => "btn btn-default", "title" => app_lang('manage_labels'), "data-post-type" => "project"));
                    }
                }
                ?>
            </div>
...
<?php } ?>
        ...
        $("#project-table").appTable({
            source: '<?php echo_uri("enterprises/list_data") ?>',
