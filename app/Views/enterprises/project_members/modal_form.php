<?php echo form_open(get_uri("enterprises/save_project_member"), array("id" => "project-member-form", "class" => "general-form", "role" => "form")); ?>
...
<div class="modal-footer">
    <div id="link-of-add-task-modal" class="hide">
        <?php echo modal_anchor(get_uri("responsibility/modal_form"), "", array()); ?>
    </div>
