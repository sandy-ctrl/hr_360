<div class="card">
    <div class="tab-title clearfix">
        ...
        <div class="title-button-group">
            <?php echo modal_anchor(get_uri("tokens/modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_ticket'), array("class" => "btn btn-default mb0", "title" => app_lang('add_ticket'), "data-post-project_id" => $project_id)); ?>
        </div>
    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#ticket-table").appTable({
            source: '<?php echo_uri("tokens/ticket_list_data_of_project/" . $project_id) ?>',
            order: [[0, "asc"]],
            columns: [
