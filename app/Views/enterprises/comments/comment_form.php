...
if (isset($task_id)) {
    $comment_type = "task";
    $url = "responsibility/save_comment";
...
$mention_source = get_uri("enterprises/get_member_suggestion_to_mention");
if (isset($model_info->context) && $model_info->context != "project") {
    $mention_source = get_uri("responsibility/get_member_suggestion_to_mention");
}
?>
