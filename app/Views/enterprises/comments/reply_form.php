<?php echo form_open(get_uri("enterprises/save_comment"), array("class" => "reply-form general-form", "role" => "form")); ?>
<?php
$parent_id = 0;
if (isset($comment_id)) {
    ...
    <div class="w-100">
        <div id="<?php echo "reply-dropzone-" . $parent_id; ?>"  class="post-dropzone form-group">
            ...
            echo form_textarea(array(
                ...
                "data-mention" => true,
                "data-mention-source" => get_uri("enterprises/get_member_suggestion_to_mention"),
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('.comment_reply_description').appMention({
            source: "<?php echo_uri("enterprises/get_member_suggestion_to_mention"); ?>",
