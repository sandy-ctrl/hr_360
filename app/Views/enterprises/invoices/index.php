    ...
    <div class="tab-title clearfix">
        ...
        <div class="title-button-group">
            ...
            if ($can_edit_invoices) {
                echo modal_anchor(get_uri("bills/modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_invoice'), array("class" => "btn btn-default", "title" => app_lang('add_invoice'), "data-post-project_id" => $project_id));
            }
            ?>
        </div>
    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#invoice-table").appTable({
            source: '<?php echo_uri("bills/invoice_list_data_of_project/" . $project_id . "/" . $project_info->client_id) ?>',
            order: [[0, "desc"]],
