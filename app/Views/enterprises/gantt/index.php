...
echo modal_anchor(get_uri("responsibility/view"), "", array("id" => "show_task_hidden", "class" => "hide", "data-modal-lg" => "1"));
?>
...
<script type="text/javascript">
    var loadGantt = function (group_by, milestoneId, userId, status, projectId, scrollToLast) {
        ...
        $.ajax({
            url: "<?php echo get_uri("responsibility/gantt_data/"); ?>" + projectId + "/" + group_by + "/" + milestoneId + "/" + userId + "/" + status,
            type: 'POST',
            dataType: 'json',
