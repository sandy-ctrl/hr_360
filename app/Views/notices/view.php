<div id="page-content" class="page-wrapper clearfix">
    <div class="view-container">
        <div class="pt10 pb10 text-right"> &larr; <?php echo anchor("notices", app_lang("announcements")); ?></div>
                ...
                <div class="mt20">
                    ...
                    if ($announcement->files) {
                        ...
                        if ($total_files) {
                            ...
                            echo anchor(get_uri("notices/download_announcement_files/" . $announcement->id), $download_caption, array("class" => "", "title" => $download_caption));
                        }
                    }
                    ?>
                </div>
