<div id="page-content" class="page-wrapper clearfix">
    <div class="card view-container">
        <div id="announcement-dropzone" class="post-dropzone">
            <?php echo form_open(get_uri("notices/save"), array("id" => "announcement-form", "class" => "general-form", "role" => "form")); ?>
                ...
                <div class="page-title clearfix">
                    <?php if ($model_info->id) { ?>
                        ...
                        <div class="title-button-group">
                            <?php echo anchor(get_uri("notices/view/" . $model_info->id), "<i data-feather='external-link' class='icon-16'></i> " . app_lang('view'), array("class" => "btn btn-default", "title" => app_lang('view'))); ?>
                        </div>
                    <?php } else { ?>
