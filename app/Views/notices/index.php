    ...
    <div class="card announcements-page">
        <div class="page-title clearfix">
            ...
            <div class="title-button-group">
                <?php
                if ($show_add_button) {
                    echo anchor(get_uri("notices/form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_announcement'), array("class" => "btn btn-default", "title" => app_lang('add_announcement')));
                };
                ?>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#announcement-table").appTable({
            source: '<?php echo_uri("notices/list_data") ?>',
            order: [[2, "desc"]],
            columns: [
