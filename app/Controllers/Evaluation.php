...
class Evaluation extends Security_Controller {
    ...
    function preview($estimate_id = 0, $public_key = "") {
        ...
        return view("evaluations/estimate_public_preview", $view_data);
    }
    ...
    function accept_estimate_modal_form($estimate_id = 0, $public_key = "") {
        ...
        return $this->template->view('evaluations/accept_estimate_modal_form', $view_data);
    }
    ...
    function accept_estimate() {
        ...
        if ($this->Evaluations_model->ci_save($estimate_data, $estimate_id)) {
