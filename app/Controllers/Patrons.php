...
class Patrons extends Security_Controller
{
    ...
    function index($tab = "")
    {
        ...
        return $this->template->rander("patrons/index", $view_data);
    }
    ...
    function modal_form()
    {
        ...
        $view_data['label_column'] = "control-label";
        $view_data['field_column'] = "col-md-12";
        ...
        $view_data['model_info'] = $this->Patrons_model->get_one($client_id);
        ...
        return $this->template->view('patrons/modal_form', $view_data);
    }
    ...
    function save()
    {
        ...
        if ($this->login_user->is_admin) {
            ...
            if ($client_id && get_array_value($data, "currency")) {
                $client_info = $this->Patrons_model->get_one($client_id);
                if ($client_info->currency !== $data["currency"] && !$this->Patrons_model->is_currency_editable($client_id)) {
        ...
        if (get_setting("disallow_duplicate_client_company_name") == "1" && $this->Patrons_model->is_duplicate_company_name($data["company_name"], $client_id)) {
            echo json_encode(array("success" => false, 'message' => app_lang("account_already_exists_for_your_company_name")));
            exit();
        }

        $save_id = $this->Patrons_model->ci_save($data, $client_id);
    ...
    function delete()
    {
        ...
        if ($this->Patrons_model->delete_client_and_sub_items($id)) {
    ...
    function list_data()
    {
        ...
        $result = $this->Patrons_model->get_details($all_options);
    ...
    private function _row_data($id)
    {
        ...
        $data = $this->Patrons_model->get_details($options)->getRow();
    ...
    private function _make_row($data, $custom_fields)
    {
        ...
        $row_data = array(
            $data->id,
            anchor(get_uri("patrons/view/" . $data->id), $data->company_name),
        ...
        $row_data[] = modal_anchor(get_uri("patrons/modal_form"), "<i data-feather='edit' class='icon-16'></i>", array("class" => "edit", "title" => app_lang('edit_client'), "data-post-id" => $data->id))
            . js_anchor("<i data-feather='x' class='icon-16'></i>", array('title' => app_lang('delete_client'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("patrons/delete"), "data-action" => "delete-confirmation"));
    ...
    function view($client_id = 0, $tab = "", $folder_id = 0)
    {
        ...
        if ($client_id) {
            ...
            $client_info = $this->Patrons_model->get_details($options)->getRow();
            if ($client_info && !$client_info->is_lead) {
                ...
                return $this->template->rander("patrons/view", $view_data);
            } else {
                show_404();
            }
        } else {
    ...
    function add_remove_star($client_id, $type = "add")
    {
        if ($client_id) {
            ...
            if ($type === "add") {
                $this->Patrons_model->add_remove_star($client_id, $this->login_user->id, $type = "add");
                return $this->template->view('patrons/star/starred', $view_data);
            } else {
                $this->Patrons_model->add_remove_star($client_id, $this->login_user->id, $type = "remove");
                return $this->template->view('patrons/star/not_starred', $view_data);
            }
        }
    }
    ...
    {
        $view_data["clients"] = $this->Patrons_model->get_starred_clients($this->login_user->id, $this->allowed_client_groups)->getResult();
        return $this->template->view('patrons/star/clients_list', $view_data);
    }
    ...
    function projects($client_id)
    {
        ...
        return $this->template->view("patrons/projects/index", $view_data);
    }
    ...
    function payments($client_id)
    {
        ...
        if ($client_id) {
            $view_data["client_info"] = $this->Patrons_model->get_one($client_id);
            $view_data['client_id'] = clean_data($client_id);
            return $this->template->view("patrons/payments/index", $view_data);
        }
    }
    ...
    function tickets($client_id)
    {
        ...
        if ($client_id) {
            ...
            return $this->template->view("patrons/tickets/index", $view_data);
        }
    }
    ...
    function invoices($client_id)
    {
        ...
        if ($client_id) {
            ...
            return $this->template->view("patrons/invoices/index", $view_data);
        }
    }
    ...
    function estimates($client_id)
    {
        ...
        if ($client_id) {
            ...
            return $this->template->view("patrons/estimates/estimates", $view_data);
        }
    }
    ...
    function orders($client_id)
    {
        ...
        if ($client_id) {
            ...
            return $this->template->view("patrons/orders/orders", $view_data);
        }
    }
    ...
    function estimate_requests($client_id)
    {
        ...
        if ($client_id) {
            $view_data['client_id'] = clean_data($client_id);
            return $this->template->view("patrons/estimates/estimate_requests", $view_data);
        }
    }
    ...
    function notes($client_id)
    {
        ...
        if ($client_id) {
            $view_data['client_id'] = clean_data($client_id);
            return $this->template->view("patrons/notes/index", $view_data);
        }
    }
    ...
    function events($client_id)
    {
        ...
        if ($client_id) {
            ...
            return $this->template->view("schedules/index", $view_data);
        }
    }
    ...
    function files($client_id, $view_type = "", $folder_id = 0)
    {
        ...
        if ($view_type == "page_view") {
            ...
            return $this->template->rander("patrons/files/index", $view_data);
        } else {
            return $this->template->view("patrons/files/index", $view_data);
        }
    }
    ...
    function file_modal_form()
    {
        ...
        return $this->template->view('patrons/files/modal_form', $view_data);
    }
    ...
    private function _make_file_row($data)
    {
        ...
        $description = "<div class='float-start'>" .
            js_anchor(remove_file_prefix($data->file_name), array('title' => "", "data-toggle" => "app-modal", "data-sidebar" => "0", "data-group" => "general_files", "data-url" => get_uri("patrons/view_file/" . $data->id)));
        ...
        $options = anchor(get_uri("patrons/download_file/" . $data->id), "<i data-feather='download-cloud' class='icon-16'></i>", array("title" => app_lang("download")));

        if ($this->login_user->user_type == "staff") {
            $options .= js_anchor("<i data-feather='x' class='icon-16'></i>", array('title' => app_lang('delete_file'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("patrons/delete_file"), "data-action" => "delete-confirmation"));
        }
    ...
    function view_file($file_id = 0)
    {
        ...
        if ($file_info) {
            ...
            return $this->template->view("patrons/files/view", $view_data);
        } else {
            show_404();
        }
    }
    ...
    function contact_profile($contact_id = 0, $tab = "")
    {
        ...
        $view_data['client_info'] = $this->Patrons_model->get_one($view_data['user_info']->client_id);
        $view_data['tab'] = clean_data($tab);
        $view_data['can_edit_clients'] = $this->can_edit_clients();
        if ($view_data['user_info']->user_type === "client") {
            ...
            return $this->template->rander("patrons/contacts/view", $view_data);
        } else {
            show_404();
        }
    }
    ...
    function my_preferences()
    {
        ...
        return $this->template->view("patrons/contacts/my_preferences", $view_data);
    }
    ...
    function contacts($client_id = 0)
    {
        ...
        return $this->template->view("patrons/contacts/index", $view_data);
    }
    ...
    function add_new_contact_modal_form()
    {
        ...
        return $this->template->view('patrons/contacts/modal_form', $view_data);
    }
    ...
    function contact_general_info_tab($contact_id = 0)
    {
        if ($contact_id) {
            ...
            return $this->template->view('patrons/contacts/contact_general_info_tab', $view_data);
        }
    }
    ...
    function company_info_tab($client_id = 0)
    {
        if ($client_id) {
            ...
            return $this->template->view('patrons/contacts/company_info_tab', $view_data);
        }
    }
    ...
    function save_contact()
    {
        ...
        if (!$contact_id) {
            ...
            $primary_contact = $this->Patrons_model->get_primary_contact($client_id);
            if (!$primary_contact) {
    ...
    private function _make_contact_row($data, $custom_fields, $hide_primary_contact_label = false)
    {
        ...
        $contact_link = anchor(get_uri("patrons/contact_profile/" . $data->id), $full_name . $primary_contact) . $removal_request_pending;
        if ($this->login_user->user_type === "client") {
            $contact_link = $full_name; //don't show clickable link to client
        }

        $client_info = $this->Patrons_model->get_one($data->client_id);

        $contact_permissions = modal_anchor(get_uri("patrons/contact_permissions_modal_form"), "<i data-feather='key' class='icon-16'></i>", array("class" => "edit", "title" => app_lang('user_permissions'), "data-post-id" => $data->id));

        $row_data = array(
            $user_avatar,
            $contact_link,
            anchor(get_uri("patrons/view/" . $data->client_id), $client_info->company_name),
            $data->job_title,
            $data->email,
        ...
        $row_data[] = js_anchor("<i data-feather='x' class='icon-16'></i>", array('title' => app_lang('delete_contact'), "class" => "delete", "data-id" => "$data->id", "data-action-url" => get_uri("patrons/delete_contact"), "data-action" => "delete"));
    ...
    function invitation_modal()
    {
        ...
        return $this->template->view('patrons/contacts/invitation_modal', $view_data);
    }
    ...
    function users()
    {
        if ($this->login_user->user_type === "client") {
            ...
            return $this->template->rander("patrons/contacts/users", $view_data);
        }
    }
    ...
    {
        return $this->template->view('unit_members/keyboard_shortcut_modal_form');
    }
    ...
    function import_clients_modal_form()
    {
        ...
        return $this->template->view("patrons/import_clients_modal_form");
    }
    ...
    function save_client_from_excel_file()
    {
        ...
        foreach ($excel_file as $key => $value) { //rows
            ...
            //save client data
            $client_save_id = $this->Patrons_model->ci_save($client_data);
            if (!$client_save_id) {
                continue;
            }
    ...
    {
        $view_data["user_info"] = $this->Users_model->get_one($this->login_user->id);
        return $this->template->view("patrons/contacts/gdpr", $view_data);
    }
    ...
    private function _make_export_data($user_info)
    {
        ...
        //add company info
        $client_info = $this->Patrons_model->get_one($user_info->client_id);
    ...
    function request_my_account_removal()
    {
        if (get_setting("enable_gdpr") && get_setting("clients_can_request_account_removal")) {
            ...
            app_redirect("patrons/contact_profile/$user_id/gdpr");
        }
    }
    ...
    function expenses($client_id)
    {
        ...
        if ($client_id) {
            ...
            return $this->template->view("patrons/expenses/index", $view_data);
        }
    }
    ...
    function contracts($client_id)
    {
        ...
        if ($client_id) {
            ...
            return $this->template->view("patrons/contracts/contracts", $view_data);
        }
    }
    ...
    function clients_list()
    {
        ...
        return $this->template->view("patrons/clients_list", $view_data);
    }
    ...
    function proposals($client_id)
    {
        ...
        if ($client_id) {
            ...
            return $this->template->view("patrons/proposals/proposals", $view_data);
        }
    }
    ...
    function tasks($client_id)
    {
        ...
        $view_data['client_id'] = clean_data($client_id);
        return $this->template->view("patrons/tasks/index", $view_data);
    }
    ...
    function subscriptions($client_id)
    {
        ...
        if ($client_id) {
            ...
            return $this->template->view("patrons/subscriptions/index", $view_data);
        }
    }
    ...
    function contact_permissions($contact_id)
    {
        ...
        $view_data['label_column'] = "col-md-2";
        $view_data['field_column'] = "col-md-10";
        return $this->template->view("patrons/contacts/contact_permissions", $view_data);
    }
    ...
    function save_contact_permissions($contact_id)
    {
        ...
        $primary_contact = $this->Patrons_model->get_primary_contact($user_info->client_id);
    ...
    function contact_permissions_modal_form()
    {
        ...
        return $this->template->view('patrons/contacts/contact_permissions_modal_form', $view_data);
    }
