...
class Unit_members extends Security_Controller {
    ...
    public function index() {
        ...
        return $this->template->rander("unit_members/index", $view_data);
    }
    ...
    function modal_form() {
        ...
        return $this->template->view('unit_members/modal_form', $view_data);
    }
    ...
    function invitation_modal() {
        ...
        return $this->template->view('unit_members/invitation_modal', $view_data);
    }
    ...
    private function _make_row($data, $custom_fields) {
        ...
        if ($this->_can_delete_team_member($data)) {
            $delete_link = js_anchor("<i data-feather='x' class='icon-16'></i>", array('title' => app_lang('delete_team_member'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("unit_members/delete"), "data-action" => "delete-confirmation"));
        }
    ...
    function view($id = 0, $tab = "") {
        if ($id * 1) {
            ...
            if ($user_info) {
                ...
                return $this->template->rander("unit_members/view", $view_data);
            } else {
                show_404();
            }
        } else {
            ...
            return $this->template->rander("unit_members/profile_card", $view_data);
        }
    }
    ...
    function job_info($user_id) {
        ...
        return $this->template->view("unit_members/job_info", $view_data);
    }
    ...
    function general_info($user_id) {
        ...
        return $this->template->view("unit_members/general_info", $view_data);
    }
    ...
    function my_preferences() {
        ...
        return $this->template->view("unit_members/my_preferences", $view_data);
    }
    ...
    function projects_info($user_id) {
        if ($user_id) {
            ...
            return $this->template->view("unit_members/projects_info", $view_data);
        }
    }
    ...
    function attendance_info($user_id) {
        if ($user_id) {
            validate_numeric_value($user_id);
            $view_data['user_id'] = $user_id;
            return $this->template->view("unit_members/attendance_info", $view_data);
        }
    }

    //show weekly attendance list of a team member
    function weekly_attendance() {
        return $this->template->view("unit_members/weekly_attendance");
    }

    //show weekly attendance list of a team member
    function custom_range_attendance() {
        return $this->template->view("unit_members/custom_range_attendance");
    }
    ...
    function attendance_summary($user_id) {
        validate_numeric_value($user_id);
        $view_data["user_id"] = $user_id;
        return $this->template->view("unit_members/attendance_summary", $view_data);
    }
    ...
    function leave_info($applicant_id) {
        if ($applicant_id) {
            ...
            return $this->template->view("unit_members/leave_info", $view_data);
        }
    }

    //show yearly leave list of a team member
    function yearly_leaves() {
        return $this->template->view("unit_members/yearly_leaves");
    }
    ...
    function expense_info($user_id) {
        ...
        return $this->template->view("unit_members/expenses", $view_data);
    }
    ...
    function files($user_id) {
        ...
        $view_data['user_id'] = $user_id;
        return $this->template->view("unit_members/files/index", $view_data);
    }
    ...
    function file_modal_form() {
        ...
        $view_data['user_id'] = $user_id;
        return $this->template->view('unit_members/files/modal_form', $view_data);
    }
    ...
    private function _make_file_row($data) {
        ...
        $description = "<div class='float-start'>" .
                js_anchor(remove_file_prefix($data->file_name), array('title' => "", "data-toggle" => "app-modal", "data-sidebar" => "0", "data-url" => get_uri("unit_members/view_file/" . $data->id)));
        ...
        $options = anchor(get_uri("unit_members/download_file/" . $data->id), "<i data-feather='download-cloud' class='icon-16'></i>", array("title" => app_lang("download")));

        if ($this->login_user->is_admin || $data->uploaded_by == $this->login_user->id) {
            $options .= js_anchor("<i data-feather='x' class='icon-16'></i>", array('title' => app_lang('delete_file'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("unit_members/delete_file"), "data-action" => "delete-confirmation"));
        }
    ...
    function view_file($file_id = 0) {
        ...
        if ($file_info) {
            ...
            return $this->template->view("unit_members/files/view", $view_data);
        } else {
            show_404();
        }
    }
    ...
    function recently_meaning_modal_form() {
        $view_data["recently_meaning_dropdown"] = $this->get_recently_meaning_dropdown();
        return $this->template->view('responsibility/recently_meaning_modal_form', $view_data);
    }
    ...
    function notes($user_id) {
        ...
        if ($user_id) {
            ...
            return $this->template->view("unit_members/notes/index", $view_data);
        }
    }
