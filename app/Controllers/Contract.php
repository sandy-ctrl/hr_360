...
class Contract extends Security_Controller
{
    ...
    function preview($contract_id = 0, $public_key = "")
    {
        ...
        return view("agreements/contract_public_preview", $view_data);
    }
    ...
    function print_contract($contract_id = 0, $public_key = "")
    {
        ...
        if ($contract_id && $public_key) {
            ...
            echo json_encode(array("success" => true, "print_view" => $this->template->view("agreements/print_contract", $view_data)));
        } else {
    ...
    function accept_contract_modal_form($contract_id = 0, $public_key = "")
    {
        ...
        return $this->template->view('agreements/accept_contract_modal_form', $view_data);
    }
    ...
    function file_preview($id = "", $key = "", $public_key = "")
    {
        ...
        return $this->template->view("agreements/file_preview", $view_data);
    }
