...
class Support extends Security_Controller {
    ...
    function index() {
        ...
        $view_data["type"] = $type;
        return $this->template->rander("help_and_information_hub/index", $view_data);
    }
    ...
    function view($id = 0) {
        ...
        return $this->template->rander('help_and_information_hub/articles/view_page', $view_data);
    }
    ...
    function help_articles() {
        ...
        return $this->template->rander("help_and_information_hub/articles/index", $view_data);
    }
    ...
    function help_categories() {
        ...
        $view_data["type"] = "help";
        return $this->template->rander("help_and_information_hub/categories/index", $view_data);
    }
    ...
    function category_modal_form($type) {
        ...
        return $this->template->view('help_and_information_hub/categories/modal_form', $view_data);
    }
    ...
    private function _make_category_row($data) {
        return array(
            ...
            $data->sort,
            modal_anchor(get_uri("support/category_modal_form/" . $data->type), "<i data-feather='edit' class='icon-16'></i>", array("class" => "edit", "title" => app_lang('edit_category'), "data-post-id" => $data->id))
            . js_anchor("<i data-feather='x' class='icon-16'></i>", array('title' => app_lang('delete_category'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("support/delete_category"), "data-action" => "delete"))
        );
    }
    ...
    function article_form($type, $id = 0) {
        ...
        return $this->template->rander('help_and_information_hub/articles/form', $view_data);
    }
    ...
    function save_article() {
        ...
        if ($save_id) {
            ...
            app_redirect("support/article_form/" . $type . "/" . $save_id);
        } else {
            $this->session->setFlashdata("error_message", app_lang('error_occurred'));
            app_redirect("support/article_form/" . $type);
        }
    }
    ...
    private function _make_article_row($data) {
        $title = anchor(get_uri("support/view/" . $data->id), $data->title);

        $feedback = "";

        if ($data->type == "knowledge_base") {
            $title = anchor(get_uri("information_hub/view/" . $data->id), $data->title);
        ...
        return array(
            ...
            $feedback,
            $data->sort,
            anchor(get_uri("support/article_form/" . $data->type . "/" . $data->id), "<i data-feather='edit' class='icon-16'></i>", array("class" => "edit", "title" => app_lang('edit_article')))
            . js_anchor("<i data-feather='x' class='icon-16'></i>", array('title' => app_lang('delete_article'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("support/delete_article"), "data-action" => "delete"))
        );
    }
