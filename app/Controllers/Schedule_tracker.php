...
class Schedule_tracker extends App_Controller
{
    ...
    function load($random_id = "")
    {
        ...
        try {
            ...
            if ($random_id) {
                ...
                $event_tracker_info = $Schedule_tracker_model->get_one_where(array("random_id" => $random_id));
                ...
                $Schedule_tracker_model->ci_save($event_tracker_data, $event_tracker_info->id);
            }
