...
class Offer extends Security_Controller
{
    ...
    function preview($proposal_id = 0, $public_key = "")
    {
        ...
        return view("plans/proposal_public_preview", $view_data);
    }
    ...
    function print_proposal($proposal_id = 0, $public_key = "")
    {
        ...
        if ($proposal_id && $public_key) {
            ...
            echo json_encode(array("success" => true, "print_view" => $this->template->view("plans/print_proposal", $view_data)));
        } else {
    ...
    function accept_proposal_modal_form($proposal_id = 0, $public_key = "")
    {
        ...
        return $this->template->view('plans/accept_proposal_modal_form', $view_data);
    }
