...
class Agenda extends Security_Controller {
    ...
    function index() {
        ...
        if (get_array_value($this->login_user->permissions, "message_permission") !== "no") {
            $view_data['team_members'] = $this->Memos_model->get_users_for_messaging($this->get_user_options_for_query("staff"))->getResult();
        }

        return $this->template->rander("agenda/index", $view_data);
    }
    ...
    function save() {
        ...
        if ($save_id) {
            ...
            if ($this->request->getPost("reload_list")) {
                ...
                $data = $this->template->view("agenda/post_list", $view_data);
            }
    ...
    function view_post_replies($post_id) {
        ...
        return $this->template->view("agenda/reply_list", $view_data);
    }
    ...
    function post_reply_form($post_id) {
        ...
        return $this->template->view("agenda/reply_form", $view_data);
    }
    ...
    function post($post_id) {
        ...
        return $this->template->rander("agenda/post_list", $view_data);
    }
