...
class Files_directory extends Security_Controller
{
    ...
    {
        $info = new \stdClass();
        $info->controller_slag = "files_directory";
        $info->add_files_modal_url = get_uri("files_directory/file_modal_form");

        $info->file_preview_url = get_uri("files_directory/view_file");
